...
window._openNewSubModal = function() {
    ...
    modal.innerHTML = `
        <div style="background:white;border-radius:16px;padding:1.5rem;width:100%;max-width:400px;">
            ...
            <input id="ns-phone" placeholder='' style="width:100%;margin-bottom:.5rem;padding:.5rem .7rem;border:1px solid #e2e8f0;border-radius:8px;font-size:.85rem;box-sizing:border-box;">
            <input id="ns-service" placeholder='' style="width:100%;margin-bottom:.5rem;padding:.5rem .7rem;border:1px solid #e2e8f0;border-radius:8px;font-size:.85rem;box-sizing:border-box;">
...
window._openNewCertModal = function() {
    ...
    modal.innerHTML = `
        <div style="background:white;border-radius:16px;padding:1.5rem;width:100%;max-width:380px;">
            ...
            <input id="nc-by" placeholder='' style="width:100%;margin-bottom:.5rem;padding:.5rem .7rem;border:1px solid #e2e8f0;border-radius:8px;font-size:.85rem;box-sizing:border-box;">
            ...
            <input id="nc-amount" type="number" value="1000" placeholder='' style="width:100%;margin-bottom:.5rem;padding:.5rem .7rem;border:1px solid #e2e8f0;border-radius:8px;font-size:.85rem;box-sizing:border-box;">
            <div style="display:flex;gap:.5rem;margin-top:.75rem;">
