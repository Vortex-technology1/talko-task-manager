...
'use strict';
        ...
        async function saveTask(e) {
            ...
            try {
                ...
                // FIX B: check review for both existing AND new tasks
                const taskForReviewCheck = existingForReview || { creatorId: data.creatorId, assigneeId: data.assigneeId, requireReview: data.requireReview, autoGenerated: false };
