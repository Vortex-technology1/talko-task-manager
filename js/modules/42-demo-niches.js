...
window._DEMO_NICHE_MAP['beauty_salon'] = async function() {
    ...
    const TASKS = [
        // Маркетинг (fi:0)
        {t:'Запустити таргетовану рекламу Instagram — акція на квітень',    fi:0, ai:9, d:3,  pr:'high',   est:120, st:'in_progress', r:'Кампанія активна, перші ліди є'},
        {t:'Зробити Reels для TikTok — нарощування нігтів Аліна',          fi:0, ai:9, d:5,  pr:'high',   est:180, st:'new',         r:'Відео опубліковано, 5000+ переглядів'},
        {t:'Відповісти на всі відгуки Google за тиждень',                   fi:0, ai:1, d:1,  pr:'medium', est:30,  st:'review',      r:'Всі відгуки отримали відповідь'},
        {t:'Розробити офер на абонемент "5+1 безкоштовно" — промо травень', fi:0, ai:0, d:0,  pr:'high',   est:90,  st:'new',         r:'Офер погоджений, пост готовий до публікації'},
        // Адміністрування (fi:1)
        {t:'Дзвінок всім клієнтам, які не були більше 6 тижнів (win-back)', fi:1, ai:7, d:-2, pr:'high',   est:240, st:'in_progress', r:'50 клієнтів обдзвонено, 8 записів'},
        {t:'Оновити розклад майстрів на травень — погодити відпустки',      fi:1, ai:1, d:-1, pr:'high',   est:60,  st:'review',      r:'Розклад затверджений, всі майстри погодили'},
        {t:'Підтвердити записи на понеділок — SMS розсилка',                fi:1, ai:1, d:0,  pr:'medium', est:20,  st:'new',         r:'Розсилка відправлена, підтверджено 32/35'},
        // Послуги (fi:2)
        {t:'Провести атестацію майстрів манікюру — перевірка якості',       fi:2, ai:0, d:-3, pr:'high',   est:180, st:'in_progress', r:'Атестацію пройшли всі 3 майстри, протокол підписано'},
        {t:'Навчання Вікторії — техніка Мілена (комбі-манікюр)',           fi:2, ai:3, d:14, pr:'medium', est:480, st:'new',         r:'Навчання завершено, сертифікат отримано'},
        {t:'Закупити новинки весна — колекція OPI Spring 2025',            fi:5, ai:0, d:0,  pr:'high',   est:45,  st:'new',         r:'Замовлення оформлено, доставка підтверджена'},
        // Сервіс (fi:3)
        {t:'Зателефонувати клієнтам після першого візиту — зворотний зв\'язок', fi:3, ai:7, d:-1, pr:'high', est:120, st:'review',      r:'Опитано 15 нових клієнтів, NPS 9.2'},
        {t:'Нарахувати бонуси за лютий по програмі лояльності',            fi:3, ai:7, d:-2, pr:'high',   est:60,  st:'in_progress', r:'Бонуси нараховані 87 активним клієнтам'},
        // Планування (fi:4)
        {t:'Підготувати бізнес-план відкриття другої точки GlowStudio',    fi:4, ai:0, d:-5, pr:'high',   est:360, st:'in_progress', r:'Бізнес-план готовий, локація обрана'},
        {t:'Аналіз завантаженості майстрів — квітень vs березень',         fi:4, ai:0, d:0,  pr:'medium', est:90,  st:'new',         r:'Звіт підготовлено, рекомендації надані'},
        // Забезпечення (fi:5)
        {t:'Оформити замовлення витратних матеріалів у постачальника',      fi:5, ai:0, d:-2, pr:'high',   est:45,  st:'review',      r:'Замовлення відправлено, дата доставки — пʼятниця'},
        {t:'Перевірити строк придатності гель-лаків — ревізія складу',     fi:5, ai:1, d:-3, pr:'medium', est:60,  st:'in_progress', r:'Ревізія проведена, прострочене списано'},
        // Фінанси (fi:6)
        {t:'Розрахувати зарплату майстрів за березень (% від виручки)',     fi:6, ai:8, d:-1, pr:'high',   est:120, st:'review',      r:'Розрахунок готовий, виплати підготовлені'},
        {t:'Подати звіт ФОП за 1 квартал',                                 fi:6, ai:8, d:14, pr:'high',   est:180, st:'new',         r:'Звіт подано, оплата ЄСВ підтверджена'},
        {t:'Звірити касу — тижневий підсумок',                             fi:6, ai:8, d:0,  pr:'medium', est:30,  st:'new',         r:'Каса зведена, розбіжностей немає'},
        // HR (fi:7)
        {t:'Провести співбесіду з кандидатом на майстра косметолога',       fi:7, ai:0, d:-4, pr:'high',   est:60,  st:'review',      r:'Кандидат обраний, пробний день призначено'},
        {t:'Скласти KPI для майстрів на квітень',                          fi:7, ai:0, d:-1, pr:'high',   est:90,  st:'in_progress', r:'KPI погоджені з кожним майстром'},
        {t:'Провести щотижневу нараду команди — підсумки тижня',           fi:7, ai:0, d:0,  pr:'medium', est:60,  st:'new',         r:'Нарада проведена, протокол записаний'},
        // Поточні (mixed)
        {t:'Замовити стенд із зразками кольорів — оновлення колекції',     fi:5, ai:1, d:8,  pr:'medium', est:30,  st:'new',         r:'Стенд замовлено, надійде через 3 дні'},
        {t:'Оновити профіль Instagram — нові фото робіт Дарини',           fi:0, ai:9, d:-2, pr:'medium', est:120, st:'in_progress', r:'15 нових фото опубліковано, охоплення +40%'},
        {t:'Виставити рахунок корпоративному клієнту Beauty Corp',         fi:6, ai:8, d:-1, pr:'high',   est:20,  st:'review',      r:'Рахунок відправлено, очікуємо оплату'},
        // Майбутні власника (для Контролю + різноманітність)
        {t:'Підготувати акцію "День народження — 30% знижка"',            fi:0, ai:0, d:7,  pr:'high',   est:120, st:'new',         r:'Акція запущена, 12 клієнтів скористались'},
        {t:'Переговори з новим постачальником OPI — умови 2025',           fi:5, ai:0, d:10, pr:'medium', est:90,  st:'new',         r:'Умови погоджені, контракт підписано'},
        {t:'Розробити систему мотивації майстрів — бонуси за KPI',        fi:7, ai:0, d:14, pr:'high',   est:180, st:'new',         r:'Система впроваджена, перші виплати проведено'},
        // Виконані (done) — для статистики і Контролю
        {t:'Провести фотозйомку портфоліо — весняна колекція 2025',       fi:0, ai:9, d:-7, pr:'medium', est:240, st:'done',        r:'120 фото відібрано, опубліковано в Instagram'},
        {t:'Укласти договір з постачальником гель-лаків Kodi',            fi:5, ai:0, d:-5, pr:'high',   est:60,  st:'done',        r:'Договір підписано, знижка 15% на оптові замовлення'},
        {t:'Провести навчання персоналу — стандарти обслуговування',       fi:7, ai:0, d:-3, pr:'high',   est:180, st:'done',        r:'Всі 9 майстрів пройшли навчання, тест здано'},
    ];
