...
// ─── BLOCKS ────────────────────────────────────────────────
const OB_BLOCKS = [
    { id: 'start',        label: 'Старт',        color: '#6366f1', icon: '🚀' },
    { id: 'tasks',        label: 'Завдання',      color: '#22c55e', icon: '✅' },
    { id: 'myday',        label: 'Мій день',      color: '#f59e0b', icon: '☀️' },
    { id: 'system',       label: 'Система',       color: '#8b5cf6', icon: '⚙️' },
    { id: 'projects',     label: 'Проєкти',       color: '#3b82f6', icon: '📁' },
    { id: 'coordination', label: 'Координації',   color: '#f59e0b', icon: '🤝' },
    { id: 'analytics',    label: 'Аналітика',     color: '#8b5cf6', icon: '📊' },
    { id: 'finance',      label: 'Фінанси',       color: '#10b981', icon: '💰' },
    { id: 'business',     label: 'Бізнес',        color: '#f97316', icon: '🏢' },
    { id: 'learning',     label: 'Навчання',      color: '#0ea5e9', icon: '📚' },
];
    ...
    <div style="max-width:660px;margin:0 auto;">
      <div style="display:flex;align-items:flex-start;gap:.85rem;margin-bottom:1.25rem;">
        ...
        <div style="flex:1;">
          ...
          <div style="font-size:.72rem;color:#9ca3af;margin-top:2px;">Орієнтовний час: <b>${step.est}</b></div>
        </div>
      ...
      <div style="display:flex;gap:.65rem;justify-content:space-between;">
        ...
        ${stepComplete(step)&&ob.activeStep<OB_STEPS.length-1
          ...
          : `<div onclick="ob.activeStep=-1;renderOnboarding();" style="cursor:pointer;padding:.55rem 1.1rem;background:#f0fdf4;color:#22c55e;border:1.5px solid #bbf7d0;border-radius:8px;font-size:.8rem;font-weight:700;display:flex;align-items:center;gap:5px;">🎉 Онбординг завершено!</div>`
        }
      </div>
    </div>
  </div>
