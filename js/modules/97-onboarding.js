...
// ══ БЛОК 3 — СИСТЕМА ══════════════════════════════════════════
{
    ...
    title: 'Функції: відділи, підфункції і KPI', subtitle: 'Блок 3 · Система', est: '20 хв',
    description: '<b>Навіщо це:</b> без функцій завдання висять у повітрі. З функціями — кожне завдання прив\'язане до відділу, кожен відділ має метрику, система показує де провал.<br><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#f5f3ff;border:1px solid #ddd6fe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#7c3aed;font-size:.8rem;">ЯК БУДУВАТИ ІЄРАРХІЮ (покрокова логіка)</b><br>'
      + '<span style="font-size:.78rem;color:#374151;line-height:1.7;">'
      + '1. Система → Функції → «+ Функція» → створюєте <b>батьківський відділ</b> (наприклад «Технічний департамент»)<br>'
      + '2. Натискаєте «+ Функція» знову → вводите назву підфункції → в полі <b>«Підпорядковується»</b> обираєте «Технічний департамент»<br>'
      + '3. Система сама будує схему-дерево в режимі «Структура» — не потрібно нічого малювати вручну<br>'
      + '4. Додаєте ще підфункції — вони теж підтягуються автоматично<br>'
      + '</span></div>'
      + '<div style="background:#f5f3ff;border:1px solid #ddd6fe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#7c3aed;font-size:.8rem;">ПРИКЛАД: БУДІВЕЛЬНА КОМПАНІЯ</b><br>'
      + '<span style="font-size:.78rem;color:#374151;line-height:1.7;">'
      + '🏗 Технічний департамент<br>'
      + '&nbsp;&nbsp;&nbsp;↳ Планування (метрика: % виконання плану)<br>'
      + '&nbsp;&nbsp;&nbsp;↳ Забезпечення (метрика: % вчасних закупок)<br>'
      + '&nbsp;&nbsp;&nbsp;↳ Виробництво → Початок робіт → Демонтаж → Чистові роботи<br>'
      + '💼 Комерційний відділ<br>'
      + '&nbsp;&nbsp;&nbsp;↳ Продажі (метрика: кількість нових угод/місяць)<br>'
      + '&nbsp;&nbsp;&nbsp;↳ Кошторисування (метрика: час підготовки кошторису)<br>'
      + '</span></div>'
      + '<div style="background:#f5f3ff;border:1px solid #ddd6fe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#7c3aed;font-size:.8rem;">KPI — КОНКРЕТНІ ЧИСЛА</b><br>'
      + '<span style="font-size:.78rem;color:#374151;line-height:1.6;">'
      + 'Всередині функції → «+ KPI» → Назва / Ціль / Одиниця виміру<br>'
      + 'Правильно: «Нові угоди — 20 — шт/місяць»<br>'
      + 'Неправильно: «Збільшити продажі»<br>'
      + 'KPI + завдання = ви платите не за процес, а за результат'
      + '</span></div>'
      + '</div>'
      + '<a href="https://chatgpt.com/g/g-69382bfa841881918aff7b50aa25a4f9-talko-task-manager-support" target="_blank" style="display:inline-flex;align-items:center;gap:6px;padding:6px 14px;background:#8b5cf6;color:white;border-radius:8px;font-size:.82rem;font-weight:700;text-decoration:none;">Запитати AI-асистента</a>',
    tasks: [
        ...
        { id:'f2', text:'Створити мінімум 3 батьківські функції (відділи)', detail:'Кнопка «+ Функція» → назва → відповідальний. Не заглиблюйтесь з першого разу: Продажі, Операційна, Фінанси — цього достатньо для старту.' },
        { id:'f3', text:'Додати підфункції через поле «Підпорядковується»', detail:'«+ Функція» → назва підфункції → поле «Підпорядковується» → оберіть батьківський відділ. Система сама побудує ієрархію. Перевірте в режимі «Структура» → має з\'явитись дерево.' },
        { id:'f4', text:'До кожної функції додати мінімум 1 KPI з конкретним числом', detail:'Всередині функції → «+ KPI» → Назва / Ціль / Одиниця виміру. Приклад: «Нові угоди — 20 — шт/місяць» або «Час закриття вакансії — 14 — днів».' },
        { id:'f5', text:'Переключитись в режим «Структура» і перевірити схему-дерево', detail:'Кнопка «Структура» вгорі вкладки. Видно повну ієрархію: хто кому підпорядковується, яка метрика у кожного відділу. Якщо схема неправильна — поверніться в картки і виправте поле «Підпорядковується».' },
        { id:'f6', text:'Прив\'язати існуючі завдання до відповідних функцій', detail:'Відкрийте будь-яке завдання → поле «Функція» → оберіть відділ. Або масово: Завдання → фільтр → вибрати без функції → редагувати. Без прив\'язки завдання не потрапляють в аналітику по відділах.' },
    ],
    action: { label:'Відкрити функції', tab:'functions' },
    tip: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline;vertical-align:middle;margin-right:4px;flex-shrink:0;"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> Ключове: спочатку структура (батьківські відділи), потім підфункції. Намагатись одразу зробити «правильно» — помилка. Почніть з 3 відділів, решта добудується з практики.'
},
{
...
// ══ БЛОК 6 — АНАЛІТИКА ════════════════════════════════════════
{
    ...
    title: 'Ефективність та Статистика: цифри замість відчуттів', subtitle: 'Блок 6 · Аналітика', est: '15 хв',
    description: '<b>Біль без цього:</b> власник управляє «по відчуттях». Проблема виникла — незрозуміло де і коли почалась, хто винен, чи це системна проблема чи разовий збій.<br><br>'
      + '<b>Без аналітики:</b> «мені здається співробітник А працює гірше за Б», «здається продажі впали», «не знаю чи ростемо ми чи стоїмо на місці».<br>'
      + '<b>З аналітикою:</b> «співробітник А виконує 87% завдань вчасно (норма 90%), Б — 95%», «продажі впали на 12% цього місяця порівняно з минулим», «ростемо на 8% щомісяця протягом кварталу».<br><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#f5f3ff;border:1px solid #e9d5ff;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#6b21a8;font-size:.82rem;">ЕФЕКТИВНІСТЬ КОМАНДИ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">KPI по кожному співробітнику: <b>виконано вчасно</b> (в %), <b>прострочено</b> (кількість), <b>середній час виконання</b> (днів).<br>'
      + 'Фільтри: по відділу, по періоду (тиждень, місяць, квартал), по типу завдань.<br>'
      + 'Графік динаміки: бачите чи покращується виконання чи погіршується. Тренд за 12 тижнів.</span>'
      + '</div>'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#1e40af;font-size:.82rem;">КАСТОМНА СТАТИСТИКА</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Ваші бізнес-метрики які ви самі додаєте: виручка за день, нових клієнтів, дзвінків, замовлень, заявок з сайту, конверсія ліди→угоди.<br>'
      + 'Вносите числа вручну щодня (30 секунд) або автоматично з CRM/Фінанси.<br>'
      + 'Графік тренду: день/тиждень/місяць. Бачите чи зростає показник чи падає.</span>'
      + '</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#166534;font-size:.82rem;">ПОРІВНЯННЯ ПЕРІОДІВ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Місяць до місяця: травень vs квітень — зріст чи падіння.<br>'
      + 'Рік до року: травень 2025 vs травень 2024 — бачите чи є прогрес за рік.<br>'
      + 'Квартал до кварталу: Q2 vs Q1 — сезонність, тренди, ефективність змін.</span>'
      + '</div>'
      + '<div style="background:#fef3c7;border:1px solid #fde68a;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#92400e;font-size:.82rem;">ЕКСПОРТ І ЗВІТИ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Експорт в Excel/CSV: вся статистика по команді, завданнях, метриках за період.<br>'
      + 'Автоматичні щотижневі звіти власнику (якщо увімкнено): скільки завершено, прострочено, ключові метрики.<br>'
      + 'Звіт для інвесторів/партнерів: PDF з графіками і цифрами за квартал.</span>'
      + '</div>'
      + '</div>'
      + '<b>Результат:</b> власник не «здається» а <b>знає</b>. Рішення приймаються на основі цифр, не інтуїції. Проблеми видно до того як вони стали критичними.'
      + AI_BTN,
    tasks: [
        { id:'an1', text:'Відкрити Аналітика → Ефективність — переглянути статистику по команді', detail:'Хто виконує вчасно а хто постійно переносить. Сортуйте по % виконання — найгірші показники вгорі. Об\'єктивні дані без емоцій.' },
        { id:'an2', text:'Фільтрувати по одному відділу або співробітнику', detail:'Оберіть відділ (наприклад «Продажі») → бачите тільки цей відділ. Оберіть співробітника → детальна статистика: які завдання прострочені, середній час виконання.' },
        { id:'an3', text:'Відкрити Статистика → Додати 3 ключові метрики свого бізнесу', detail:'«+ Нова метрика» → назва «Виручка за день» → одиниця «грн» → мета (наприклад 50,000). Додайте «Нових клієнтів», «Виконаних замовлень». Вносьте числа щодня.' },
        { id:'an4', text:'Внести дані за останні 7 днів для кожної метрики', detail:'Клік на метрику → «Додати значення» → дата → число. Заповніть 7 днів → з\'явиться графік тренду. Видно зростання чи падіння.' },
        { id:'an5', text:'Порівняти цей місяць з минулим — переглянути зміни', detail:'Оберіть метрику → кнопка «Порівняти періоди» → оберіть поточний місяць vs минулий. Система покаже: +15% зростання або -8% падіння.' },
        { id:'an6', text:'Експортувати звіт по ефективності команди в Excel', detail:'Ефективність → кнопка «Експорт» → Excel. Відкривається таблиця: співробітник, виконано, прострочено, %. Використовуйте для планерок.' },
    ],
    action: { label:'Відкрити аналітику', tab:'analytics' },
    tip: INFO_ICON + ' Якщо метрика не вимірюється — нею неможливо управляти. Заведіть 3 цифри які вносите щодня протягом тижня. Через місяць — перші висновки, через квартал — тренди.',
},

// ══ БЛОК 7 — ФІНАНСИ ══════════════════════════════════════════
// Логіка: Налаштування → Перша транзакція → Регулярні → COGS/OPEX → Рахунки клієнтам → Зв\'язки → 3 звіти
// 7 кроків — від нуля до повного фінансового контролю

{
    id: 'finance_setup', block: 'finance', color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>',
    title: 'Крок 1: Налаштування — рахунки і категорії', subtitle: 'Блок 7 · Фінанси', est: '10 хв',
    description: '<b>Без цього не буде нічого.</b> Перш ніж вносити будь-які дані — потрібно налаштувати два базові елементи: рахунки (де лежать гроші) і категорії (на що витрачаєте і звідки отримуєте).<br><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#059669;font-size:.82rem;">РАХУНКИ — ваші «гаманці»</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Кожна транзакція прив\'язана до рахунку. Типова структура: Основний рахунок (банк) + Каса (готівка).<br>'
      + 'Для кожного рахунку вказуєте <b>початковий залишок</b> — реальна сума на сьогодні. Без цього cashflow буде неточним.</span>'
      + '</div>'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#2563eb;font-size:.82rem;">КАТЕГОРІЇ — структура P&L</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Категорії доходів: Послуги, Товари, Абонементи.<br>'
      + 'Категорії витрат мають тип: <b>COGS</b> (собівартість — росте з кожним клієнтом: матеріали, зарплата майстрів) або <b>OPEX</b> (операційні — фіксовані: оренда, маркетинг, адмінзарплата).<br>'
      + 'Цей поділ визначає структуру P&L і де шукати проблему з маржею.</span>'
      + '</div>'
      + '</div>'
      + 'Витрачаєте 10 хвилин зараз → всі наступні кроки будуть давати правильну аналітику.'
      + AI_BTN,
    tasks: [
        { id:'fs1', text:'Відкрити Фінанси → Налаштування → Рахунки', detail:'Є «Основний рахунок» за замовчуванням. Відредагуйте його і додайте Касу якщо є готівкові надходження.' },
        { id:'fs2', text:'Ввести початковий залишок для кожного рахунку', detail:'Редагуйте рахунок → поле «Початковий залишок» → введіть реальну суму на сьогодні. Це стартова точка cashflow.' },
        { id:'fs3', text:'Налаштування → Категорії → додати категорії доходів', detail:'Мінімум: «Послуги» або назва вашого основного продукту. Можна додати декілька якщо є різні потоки доходу.' },
        { id:'fs4', text:'Додати категорії витрат з типом COGS і OPEX', detail:'COGS: матеріали, зарплата виконавців, підрядники. OPEX: оренда, маркетинг, зарплата адміністрації, програми.' },
    ],
    action: { label:'Відкрити налаштування', tab:'finance' },
    tip: INFO_ICON + ' Правило COGS vs OPEX: якщо завтра у вас вдвічі більше клієнтів — ця витрата зросте? Якщо так — COGS. Якщо ні (оренда та ж) — OPEX.',
},
{
    id: 'finance_first_data', block: 'finance', color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',
    title: 'Крок 2: Перші транзакції і дашборд', subtitle: 'Блок 7 · Фінанси', est: '15 хв',
    description: '<b>Фінанси без даних — красивий але порожній дашборд.</b> Після першої транзакції система оживає: з\'являються KPI, графіки, топ витрат.<br><br>'
      + '<b>Що таке транзакція і як вносити:</b><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Обов\'язкові поля:</b> Тип (Дохід/Витрата), Сума, Рахунок, Категорія, Дата оплати<br>'
      + '<b>Важливо — Дата нарахування:</b> якщо клієнт заплатив у березні за послугу яка буде в квітні → Дата оплати = березень, Дата нарахування = квітень. Cash Flow покаже гроші в березні, P&L — дохід в квітні. Якщо обидві дати однакові — поле можна не заповнювати.</div>'
      + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Прив\'язка до угоди CRM (необов\'язково):</b> якщо дохід від конкретної угоди — прив\'яжіть. Тоді в аналітиці буде видно маржу кожного проекту/угоди окремо.</div>'
      + '</div>'
      + '<b>Після внесення 5+ транзакцій дашборд покаже:</b> Дохід / Витрати / Прибуток / Маржа за місяць, SVG-графік 6 місяців, топ категорій витрат.'
      + AI_BTN,
    tasks: [
        { id:'fd1', text:'Внести 3 реальних доходи поточного місяця', detail:'Фінанси → Доходи → «+ Дохід». Заповніть: сума, категорія, рахунок, дата. Якщо є різні категорії доходу — використайте різні.' },
        { id:'fd2', text:'Внести 3 реальних витрати з правильними категоріями COGS/OPEX', detail:'Фінанси → Витрати → «+ Витрата». Обов\'язково вказуйте категорію з правильним типом — це основа P&L.' },
        { id:'fd3', text:'Переглянути дашборд — перевірити що KPI і графік заповнились', detail:'Дашборд оновлюється автоматично. Якщо цифри неправильні — перевірте рахунок і категорію транзакції.' },
        { id:'fd4', text:'Перевірити блок «Залишок по рахунках» на дашборді', detail:'Сума залишків по всіх рахунках = початковий залишок + доходи − витрати. Має збігатись з реальністю.' },
    ],
    action: { label:'Відкрити фінанси', tab:'finance' },
    tip: INFO_ICON + ' Вносьте транзакції мінімум раз на тиждень — 15 хвилин. Це єдина умова щоб система давала корисну аналітику.',
},
{
    id: 'finance_recurring', block: 'finance', color: '#10b981',
    ...
    title: 'Крок 3: Регулярні платежі — автоматизація', subtitle: 'Блок 7 · Фінанси', est: '10 хв',
    description: '<b>Оренда, зарплати, підписки — щомісяця одне й те саме.</b> Налаштовуєте один раз → система створює транзакції автоматично в потрібний день.<br><br>'
      + '<b>Що налаштовується:</b><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + 'Назва, тип (дохід/витрата), сума, рахунок, категорія<br>'
      + 'Частота: щомісяця або щотижня<br>'
      + 'День місяця або день тижня коли створювати транзакцію<br>'
      + 'Дата завершення (якщо є — наприклад кредит до серпня)<br>'
      + 'Можна поставити на паузу без видалення</div>'
      + '</div>'
      + '<b>Типові регулярні платежі:</b> оренда приміщення, зарплата (якщо фіксована), хостинг, CRM-підписка, кредит, інтернет, комунальні.<br><br>'
      + '<b>Ефект:</b> через 2 тижні система сама нагадає і запише всі постійні витрати. Ви бачите реальну картину без ручного введення щомісяця.'
      + AI_BTN,
    tasks: [
        { id:'fr1', text:'Відкрити Фінанси → Регулярні платежі', detail:'Тут список всіх шаблонів. Спочатку порожньо — додайте перший.' },
        { id:'fr2', text:'Додати оренду або інший постійний щомісячний платіж', detail:'«+ Новий» → назва «Оренда» → тип «Витрата» → сума → рахунок → категорія OPEX → день місяця (наприклад 5-го).' },
        { id:'fr3', text:'Додати зарплату (якщо виплачуєте фіксовану суму)', detail:'Окремо для кожного співробітника або загальним платежем — залежить від того чи потрібна вам деталізація по людях.' },
        { id:'fr4', text:'Перевірити що в наступний день виплати транзакція з\'явиться автоматично', detail:'Або натисніть «Виконати зараз» якщо хочете внести за поточний місяць відразу.' },
    ],
    action: { label:'Відкрити фінанси', tab:'finance' },
    tip: INFO_ICON + ' Налаштуйте всі регулярні платежі до кінця першого тижня. Тоді вже з наступного місяця вони будуть з\'являтись автоматично і витрати не загубляться.',
},
{
    id: 'finance_invoices_setup', block: 'finance', color: '#10b981',
    ...
    title: 'Крок 4: Рахунки клієнтам і автозв\'язки', subtitle: 'Блок 7 · Фінанси', est: '10 хв',
    description: '<b>Два способи щоб гроші від клієнтів потрапляли у фінанси автоматично — без подвійного введення.</b><br><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#059669;font-size:.82rem;">СПОСІБ 1: Рахунок клієнту (Invoice)</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Відкриваєте угоду в CRM → кнопка «Рахунок» → клієнт і сума підставляються автоматично → додаєте позиції → PDF за 2 хвилини → відправляєте клієнту.<br>'
      + 'Коли клієнт платить → змінюєте статус рахунку на «Оплачений» → <b>транзакція доходу в фінансах створюється автоматично</b>.<br>'
      + 'Налаштуйте реквізити компанії: Система → Налаштування → Реквізити.</span>'
      + '</div>'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#2563eb;font-size:.82rem;">СПОСІБ 2: CRM → Фінанси (автозв\'язок)</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Увімкніть toggle в Налаштуваннях → Зв\'язки між модулями.<br>'
      + 'Тепер коли угода в CRM переходить у статус «Виграно» → система запитує «Записати дохід у фінанси?» → підтверджуєте → транзакція створюється автоматично з правильною сумою і категорією.<br>'
      + 'Так само: Booking → Фінанси (оплачений запис → авто-транзакція).</span>'
      + '</div>'
      + '</div>'
      + '<b>Список несплачених рахунків</b> = ваша дебіторська заборгованість. Видно хто і скільки вам винен.'
      + AI_BTN,
    tasks: [
        { id:'fi1', text:'Заповнити реквізити компанії для рахунків', detail:'Система → Налаштування → Реквізити компанії: назва, адреса, ЄДРПОУ, банківські реквізити. Заповніть один раз — підставляються в кожен рахунок.' },
        { id:'fi2', text:'Створити тестовий рахунок з картки CRM-угоди', detail:'Відкрийте будь-яку угоду → кнопка «Рахунок» → додайте 1-2 позиції → перегляд PDF → збережіть.' },
        { id:'fi3', text:'Відмітити рахунок як «Оплачений» і перевірити що транзакція з\'явилась', detail:'Фінанси → Рахунки → знайдіть тестовий → статус «Оплачений» → перевірте Доходи — має з\'явитись нова транзакція.' },
        { id:'fi4', text:'Увімкнути автозв\'язки: CRM → Фінанси і Booking → Фінанси', detail:'Система → Налаштування → розділ «Зв\'язки між модулями» → увімкніть потрібні toggles. Протестуйте: закрийте тестову угоду.' },
    ],
    action: { label:'Відкрити фінанси', tab:'finance' },
    tip: WARN_ICON + ' Не давайте всім доступ до фінансів. Менеджер бачить суму своєї угоди — але не P&L компанії. Налаштуйте права: Система → Налаштування → Ролі.',
},
{
    id: 'finance_cashflow', block: 'finance', color: '#10b981',
    ...
    title: 'Звіт 1: Cash Flow — де гроші зараз', subtitle: 'Блок 7 · Фінанси', est: '15 хв',
    description: '<b>Cash Flow відповідає на одне питання: чи є гроші прямо зараз і коли вони прийдуть?</b><br><br>'
      + 'Бізнес може показувати прибуток по P&L — але мати нуль на рахунку. Це нормально якщо клієнти платять із затримкою. Cash Flow показує реальність.<br><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Де знайти:</b> Фінанси → Аналітика → Cash Flow<br>'
      + '<b>Що показує:</b> графік реального руху грошей по місяцях — скільки прийшло і скільки пішло. Залишок на кінець кожного місяця.</div>'
      + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Cash Flow vs P&L — різниця:</b><br>'
      + 'Клієнт заплатив 50,000 передоплати в березні за роботу яка буде в квітні.<br>'
      + 'Cash Flow березень: +50,000 (гроші прийшли)<br>'
      + 'P&L березень: 0 (послуга ще не надана)<br>'
      + 'P&L квітень: +50,000 (послуга надана)<br>'
      + 'Саме для цього є поле «Дата нарахування» в транзакції.</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Тижневий план 6M (прогноз):</b> Фінанси → Планування → «Тижневий план 6M»<br>'
      + 'Графік план/факт по кожному тижні на пів року. Синя лінія = накопичувальний залишок. Якщо лінія йде нижче нуля — касовий розрив. Бачите його за 2-3 тижні до того як він станеться.</div>'
      + '</div>'
      + '<b>Щотижнева рутина (15 хвилин):</b> внести надходження тижня → звірити з планом → якщо відхилення більше 20% → скоригувати план наступного тижня.'
      + AI_BTN,
    tasks: [
        { id:'fc1', text:'Відкрити Фінанси → Аналітика → Cash Flow', detail:'Якщо даних немає — спочатку внесіть транзакції за кілька тижнів. Графік будується автоматично.' },
        { id:'fc2', text:'Порівняти залишок Cash Flow з реальним залишком рахунків', detail:'Цифра «Залишок» в Cash Flow має збігатись з сумою по всіх рахунках на дашборді. Якщо різниця — перевірте чи всі транзакції внесені і початкові залишки правильні.' },
        { id:'fc3', text:'Відкрити Планування → Тижневий план 6M і налаштувати', detail:'Вкажіть початковий залишок → натисніть «Заповнити з середнього 3M» → скоригуйте тижні де плануєте більше або менше продажів.' },
        { id:'fc4', text:'Знайти тиждень де cashflow лінія падає нижче нуля і скоригувати план', detail:'Якщо є такий тиждень — або збільште плановий дохід (заплановані угоди) або зменшіть витрати. Це і є управління ліквідністю.' },
        { id:'fc5', text:'Внести транзакцію з різними датами оплати і нарахування', detail:'«+ Дохід» → Дата оплати = сьогодні, Дата нарахування = наступний місяць. Перевірте що в Cash Flow транзакція в цьому місяці, а в P&L — в наступному.' },
    ],
    action: { label:'Відкрити аналітику', tab:'finance' },
    tip: INFO_ICON + ' Cash Flow — перший звіт який відкривайте кожен понеділок. 2 хвилини: скільки прийшло, скільки пішло, скільки залишилось.',
},
{
    id: 'finance_pl', block: 'finance', color: '#10b981',
    ...
    title: 'Звіт 2: P&L — чи заробляє бізнес', subtitle: 'Блок 7 · Фінанси', est: '15 хв',
    description: '<b>P&L (Прибутки і збитки) відповідає на питання: чи прибутковий мій бізнес і де втрачається маржа?</b><br><br>'
      + 'На відміну від Cash Flow — P&L показує не коли прийшли гроші, а коли надана послуга. Це реальна картина прибутковості.<br><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
      + '<b>Структура P&L в TALKO:</b><br>'
      + 'Виручка (всі доходи)<br>'
      + '− COGS (собівартість) = <b>Валовий прибуток + Валова маржа %</b><br>'
      + '− OPEX (операційні витрати) = <b>Чистий прибуток + Чиста маржа %</b><br><br>'
      + 'Норма для сервісного бізнесу: Валова маржа 50-70%, Чиста маржа 20-35%.</div>'
      + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Де знайти:</b> Фінанси → Аналітика → P&L звіт<br>'
      + '<b>Фільтри:</b> по місяцях, порівняння місяців, по рахунках.<br>'
      + '<b>Маржинальність по проектах:</b> окрема вкладка в Аналітиці — яка угода/проект скільки приніс чистого.<br>'
      + '<b>Тренд витрат:</b> як змінювались витрати по категоріях за 6 місяців.<br>'
      + '<b>Експорт:</b> XLSX і PDF одним кліком.</div>'
      + '<div style="background:#fef9c3;border:1px solid #fde68a;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
      + '<b>Типова діагностика:</b><br>'
      + 'Якщо Валова маржа нормальна (60%) але Чиста маржа мала (5%) → проблема в OPEX (надто великі операційні витрати).<br>'
      + 'Якщо Валова маржа мала (20%) → проблема в COGS (висока собівартість або занизька ціна).</div>'
      + '</div>'
      + '<b>Щомісячна рутина:</b> перший робочий день місяця → P&L за минулий місяць → порівняти з попереднім → знайти відхилення більше 10% → розібратись чому.'
      + AI_BTN,
    tasks: [
        { id:'fp1', text:'Відкрити Фінанси → Аналітика → P&L звіт', detail:'Оберіть поточний місяць. Якщо категорії налаштовані правильно з COGS/OPEX — побачите повну структуру з маржею.' },
        { id:'fp2', text:'Перевірити валову маржу — вона вища за 40%?', detail:'Якщо нижча — або занизька ціна або висока собівартість. Порівняйте з минулим місяцем.' },
        { id:'fp3', text:'Відкрити вкладку «Маржинальність по проектах»', detail:'Тут видно які угоди/проекти реально прибуткові. Часто виявляється що 20% клієнтів дають 80% прибутку.' },
        { id:'fp4', text:'Порівняти P&L двох місяців', detail:'Аналітика → P&L → змінити фільтр на «Порівняння». Де виручка зросла а прибуток впав — там треба шукати причину.' },
        { id:'fp5', text:'Експортувати P&L в Excel або PDF', detail:'Кнопка «Експорт» → XLSX або PDF. Зберігайте щомісячно як архів.' },
    ],
    action: { label:'Відкрити аналітику', tab:'finance' },
    tip: INFO_ICON + ' Дивіться P&L щомісяця — перший день нового місяця. 10 хвилин: виручка, маржа, де зросли витрати. Якщо цифра здивувала — розбираєтесь до кінця тижня.',
},
{
    id: 'finance_balance', block: 'finance', color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M5 7H3a2 2 0 0 0-2 2v.5a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-2"/><path d="M5 17H3a2 2 0 0 1-2-2v-.5a2 2 0 0 1 2-2h18a2 2 0 0 1 2 2V15a2 2 0 0 1-2 2h-2"/></svg>',
    title: 'Звіт 3: Баланс — скільки коштує бізнес', subtitle: 'Блок 7 · Фінанси', est: '15 хв',
    description: '<b>Баланс відповідає на питання: скільки насправді коштує мій бізнес і скільки я винен?</b><br><br>'
      + 'Cash Flow = де гроші зараз. P&L = чи прибутковий бізнес. Баланс = скільки коштує весь бізнес як актив.<br><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#faf5ff;border:1px solid #e9d5ff;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
      + '<b style="color:#7c3aed;">АКТИВИ (що у вас є)</b><br>'
      + 'Гроші на рахунках — автоматично з фінансів<br>'
      + 'Дебіторська заборгованість — неоплачені рахунки клієнтів<br>'
      + 'Залишки на складі — автоматично зі Складу<br>'
      + 'Основні засоби — обладнання, авто, нерухомість (додаєте вручну)</div>'
      + '<div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
      + '<b style="color:#dc2626;">ПАСИВИ (що ви винні)</b><br>'
      + 'Кредиторська заборгованість — що ви винні постачальникам<br>'
      + 'Кредити і позики — тіло боргу<br>'
      + 'Інші зобов\'язання (додаєте вручну)</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
      + '<b style="color:#059669;">КАПІТАЛ = АКТИВИ − ПАСИВИ</b><br>'
      + 'Це реальна вартість вашого бізнесу. Якщо капітал зростає місяць до місяця — бізнес розвивається.'
      + '</div>'
      + '</div>'
      + '<b>Налаштування балансу:</b> Фінанси → Баланс → кнопка «Налаштування». Додайте основні засоби (обладнання), кредити, кредиторку — ці рядки система не знає автоматично.<br><br>'
      + '<b>Щоквартальна рутина:</b> раз на квартал → Баланс → порівняти Капітал з попереднім кварталом → якщо зріс — бізнес коштує більше → якщо впав — шукаєте причину.'
      + AI_BTN,
    tasks: [
        { id:'fb1', text:'Відкрити Фінанси → Баланс', detail:'Побачите три секції: Активи, Пасиви, Капітал. Частина заповнена автоматично (рахунки, дебіторка). Частина потребує ручного налаштування.' },
        { id:'fb2', text:'Натиснути «Налаштування» і додати основні засоби', detail:'Обладнання, автомобілі, нерухомість — те чим бізнес володіє але це не гроші на рахунку. Поточна ринкова або балансова вартість.' },
        { id:'fb3', text:'Додати кредити і зобов\'язання якщо є', detail:'Залишок по кредиту, заборгованість перед постачальниками. Це пасиви — зменшують реальну вартість бізнесу.' },
        { id:'fb4', text:'Перевірити суму Капіталу — це реальна вартість вашого бізнесу', detail:'Капітал = Активи − Пасиви. Запам\'ятайте цю цифру. Щоквартально звіряйте — чи зростає?' },
        { id:'fb5', text:'Зрозуміти зв\'язок трьох звітів', detail:'Cash Flow: є гроші зараз? P&L: чи прибутковий? Баланс: скільки коштує? Три питання — три відповіді. Тепер ви керуєте бізнесом цифрами, а не відчуттями.' },
    ],
    action: { label:'Відкрити баланс', tab:'finance' },
    tip: INFO_ICON + ' Після налаштування балансу у вас є повна фінансова картина. Cash Flow щотижня + P&L щомісяця + Баланс щоквартально = фінансовий контроль без бухгалтера.',
},

// ══ БЛОК 8 — БІЗНЕС: CRM (розширений) ═══════════════════════
{
    ...
    title: 'CRM: повний маршрут від ліда до проєкту', subtitle: 'Блок 8 · Бізнес', est: '30 хв',
    description: '<b>Що це дає:</b> всі клієнти, угоди, завдання і файли в одному місці. Менеджер не забуде передзвонити. Власник бачить де провал — в рекламі, в переговорах чи в обробці.<br><br>'
      + '<div style="display:grid;gap:6px;margin:8px 0;">'
      + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;"><b style="color:#c2410c;font-size:.8rem;">КАНБАН ВОРОНКИ</b><br><span style="font-size:.78rem;color:#374151;">Лід → Кваліфікація → Переговори → Комерційна пропозиція → Виграно/Програно. Перетягнули карточку — стадія змінилась, відповідальний отримав Telegram.</span></div>'
      + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;"><b style="color:#c2410c;font-size:.8rem;">ЗАВДАННЯ В УГОДІ = ЗАВДАННЯ ПЛАТФОРМИ</b><br><span style="font-size:.78rem;color:#374151;">Відкрили угоду → вкладка «Завдання» → «Нове завдання» — відкривається стандартна форма з усіма полями. Завдання автоматично з\'являється в «Мій день» виконавця і в загальному списку.</span></div>'
      + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;"><b style="color:#c2410c;font-size:.8rem;">ФАЙЛИ В УГОДІ</b><br><span style="font-size:.78rem;color:#374151;">Вкладка «Файли» в карточці — завантажуйте договори, кошториси, фото об\'єкту. Перетягніть файл або виберіть. PDF, DOC, XLSX, фото — до 20 MB.</span></div>'
      + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;"><b style="color:#c2410c;font-size:.8rem;">КОНВЕРТАЦІЯ В ПРОЄКТ</b><br><span style="font-size:.78rem;color:#374151;">Угода виграна → кнопка «В проєкт» внизу карточки → система створює проєкт з назвою клієнта. З угоди бачите проєкт, з проєкту бачите угоду. Двосторонній зв\'язок.</span></div>'
      + '</div>'
      + '<a href="https://chatgpt.com/g/g-69382bfa841881918aff7b50aa25a4f9-talko-task-manager-support" target="_blank" style="display:inline-flex;align-items:center;gap:6px;padding:6px 14px;background:#f97316;color:white;border-radius:8px;font-size:.82rem;font-weight:700;text-decoration:none;margin-top:4px;">Запитати AI-асистента</a>',
    tasks: [
        // 1-3: НАЛАШТУВАННЯ ВОРОНКИ
        { id:'crm_s1', text:'Налаштувати стадії воронки під свій бізнес', detail:'CRM → Налаштування → Воронки. Перейменуйте стадії: наприклад Новий лід → Кваліфікація → Замір → КП відправлено → Договір → Виконання → Закрито. Стадії мають відповідати вашому реальному процесу продажу.' },
        { id:'crm_s2', text:'Налаштувати автоматичну зміну відповідального при переході стадії', detail:'В налаштуваннях воронки → кожна стадія → поле «Відповідальний на стадії». Наприклад: «Замір» → відповідальний змінюється на замірника, «Кошторис» → на кошторисника. При переміщенні картки — нова людина отримує Telegram і завдання в «Мій день».' },
        { id:'crm_s3', text:'Налаштувати автозадачі при переході стадій', detail:'CRM → Налаштування → вкладка «Автозадачі при стадії». Додайте шаблони: «При переході в Замір — створити задачу «Провести замір» на замірника за 1 день». Система сама створить завдання і воно появиться в «Мій день» виконавця.' },
        // 4-6: ПЕРШИЙ ЛІД
        { id:'crm_s4', text:'Створити першого ліда вручну', detail:'CRM → Канбан → кнопка «+ Угода». Заповніть: ім\'я клієнта, телефон, сума, джерело звідки прийшов. Перші 5-10 угод краще створити вручну — щоб зрозуміти структуру картки.' },
        { id:'crm_s5', text:'Заповнити всі поля карточки угоди', detail:'Відкрийте створену угоду. Заповніть: контактні дані, стадія, сума, джерело, наступний контакт (дата коли передзвонити), нотатка. Поле «Наступний контакт» критичне — без нього угода буде «стухати» і ніхто не передзвонить.' },
        { id:'crm_s6', text:'Перемістити угоду між стадіями через drag & drop', detail:'Перетягніть картку угоди в наступну колонку. Якщо налаштований автовідповідальний — відповідальний зміниться автоматично. Якщо є автозадачі — вони з\'являться в «Мій день» нового відповідального.' },
        // 7-9: ЗАВДАННЯ І ФАЙЛИ
        { id:'crm_s7', text:'Поставити завдання прямо з угоди (вкладка «Завдання»)', detail:'Відкрийте угоду → вкладка «Завдання» → «Нове завдання». Відкриється стандартна форма платформи: назва, виконавець, дедлайн, нагадування, чекліст, очікуваний результат. Після збереження завдання автоматично з\'являється в «Мій день» виконавця і в загальному списку завдань.' },
        { id:'crm_s8', text:'Прикріпити файл до угоди (вкладка «Файли»)', detail:'Відкрийте угоду → вкладка «Файли» → перетягніть файл або натисніть зону завантаження. Підтримуються: PDF, DOC, XLSX, зображення, ZIP — до 20 MB. Файли доступні всім хто має доступ до угоди. Ідеально для договорів, кошторисів, фото об\'єктів.' },
        { id:'crm_s9', text:'Перевірити що завдання з угоди з\'явилось в «Мій день» виконавця', detail:'Відкрийте «Мій день» від імені виконавця (або попросіть виконавця перевірити). Завдання має бути там з позначкою звідки воно — від CRM угоди.' },
        // 10-12: КОНВЕРТАЦІЯ В ПРОЄКТ
        { id:'crm_s10', text:'Конвертувати угоду в проєкт кнопкою «В проєкт»', detail:'Відкрийте будь-яку активну угоду → знизу карточки кнопка «В проєкт». Система створить проєкт з назвою клієнта. Кнопка зміниться на «Відкрити проєкт →». З угоди бачите проєкт, з проєкту можна побачити пов\'язану угоду.' },
        { id:'crm_s11', text:'Перевірити що в проєкті є поле dealId (зв\'язок з угодою)', detail:'Відкрийте створений проєкт. В деталях проєкту має бути посилання на угоду або назва клієнта з CRM. Це забезпечує двосторонній зв\'язок: продажі ↔ виконання.' },
        { id:'crm_s12', text:'Запустити бізнес-процес в проєкті після конвертації', detail:'Перейшли в проєкт з кнопки «Відкрити проєкт →» → Процеси → запустити шаблон бізнес-процесу якщо є. Якщо шаблону немає — створіть задачі вручну: Замір, Кошторис, Підписання договору, Виконання, Здача.' },
        // 13-15: КЛІЄНТИ І БАЗА
        { id:'crm_s13', text:'Додати клієнта в базу і прив\'язати до угоди', detail:'CRM → Клієнти → «+ Клієнт». Заповніть контактні дані. Відкрийте угоду → поле «Клієнт» → оберіть зі списку. Тепер всі угоди клієнта видно в одному місці, навіть якщо менеджер звільниться.' },
        { id:'crm_s14', text:'Перевірити деduplication (не створювати дублі клієнтів)', detail:'При введенні телефону або email система попередить якщо клієнт вже є. Завжди шукайте клієнта перед тим як створювати нового. Дублі знищують аналітику.' },
        { id:'crm_s15', text:'Переглянути аналітику CRM: конверсія по стадіях', detail:'CRM → Аналітика. Видно: скільки лідів на кожній стадії, конверсія між стадіями, звідки приходять клієнти що платять, середній час в угоді, KPI менеджерів. Ця сторінка — головна для ухвалення рішень по продажах.' },
        // 16-17: ІНТЕГРАЦІЇ
        { id:'crm_s16', text:'Підключити Telegram-бот для автоматичного отримання лідів', detail:'CRM → Налаштування → Telegram. Скопіюйте посилання на форму або бот. Клієнт заповнює форму → лід автоматично з\'являється в CRM в потрібній стадії. Без ручного введення.' },
        { id:'crm_s17', text:'Налаштувати форму на сайті для автозаповнення CRM', detail:'CRM → Налаштування → Форми. Створіть форму → скопіюйте embed-код → вставте на сайт. Заявки з сайту → автоматично в CRM з позначкою джерела «Сайт».' },
        // 18-20: ТРИГЕРИ І ЗРІЛІСТЬ
        { id:'crm_s18', text:'Налаштувати тригер: при виграші угоди → нотифікація власнику', detail:'CRM → Налаштування → стадія «Виграно» → увімкнути сповіщення власнику. Власник отримує Telegram: «Нова угода закрита: [Клієнт], [сума]». Автоматично, без пересилань.' },
        { id:'crm_s19', text:'Перевірити що прострочені угоди підсвічуються в канбані', detail:'Угода без активності 7+ днів або з минулою датою «Наступного контакту» — підсвічується червоним. Відкрийте канбан і перевірте чи є такі. Це ваш список «пожежних» угод.' },
        { id:'crm_s20', text:'Провести перший щотижневий огляд CRM (10 хв)', detail:'Щопонеділка: відкрийте CRM → Аналітика → подивіться скільки нових лідів, скільки перейшло в наступну стадію, скільки виграно/програно. Виберіть 2-3 прострочені угоди і дайте завдання менеджеру. 10 хвилин — і ви контролюєте весь відділ продажів.' },
    ],
    action: { label:'Відкрити CRM', tab:'crm' },
    tip: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline;vertical-align:middle;margin-right:4px;flex-shrink:0;"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> Головне правило: будь-яка взаємодія з клієнтом — фіксується в CRM. Завдання з угоди = завдання в платформі = завдання в «Мій день». Одна система, без дублювання.'
},
{
    id: 'marketing', block: 'business', color: '#ec4899',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/></svg>',
    title: 'Маркетинг: звідки клієнти і скільки коштує канал', subtitle: 'Блок 8 · Бізнес', est: '15 хв',
    description: '<b>Біль без цього:</b> витрачаєте гроші на рекламу в Instagram, Google, таргет — але не знаєте звідки насправді приходять клієнти які <b>платять</b>. Маркетинговий бюджет йде навмання.<br><br>'
      + '<div style="font-size:.78rem;color:#374151;line-height:1.6;"><b>Біль:</b> витрачаєте гроші на рекламу в Instagram але не знаєте звідки насправді приходять клієнти які платять. Маркетинговий бюджет йде навмання.<br>'
      + '<b>Рішення:</b> система фіксує джерело кожного ліда (звідки прийшов) → відстежує конверсію в угоду → зв\'язує з доходом → видає звіт «ROI по каналах».</div><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#fdf2f8;border:1px solid #fbcfe8;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#be185d;font-size:.82rem;">ДЖЕРЕЛА ТРАФІКУ (UTM-мітки)</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Створіть джерела: Instagram Ads, Google Ads, Facebook, Органічний пошук, Рекомендації.<br>'
      + 'До кожного посилання на сайт/бот додайте UTM-мітку (система генерує автоматично).<br>'
      + 'Коли клієнт переходить — система запам\'ятовує джерело назавжди і прив\'язує до CRM-ліда.</span>'
      + '</div>'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#1e40af;font-size:.82rem;">АНАЛІТИКА КАНАЛІВ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Звіт «Звідки клієнти»: по кожному джерелу — скільки лідів, скільки конверсія в угоду, скільки доход.<br>'
      + 'Звіт «ROI по каналах»: витрати на рекламу (з Фінансів категорія «Маркетинг») ÷ дохід від цього каналу = ROI.<br>'
      + 'Фільтр по періодах (місяць, квартал, рік). Бачите які канали окупаються а які ні.</span>'
      + '</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#166534;font-size:.82rem;">EMAIL-РОЗСИЛКИ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">База клієнтів з CRM → вибираєте сегмент (наприклад «Не купували 3 місяці») → шаблон листа → відправка.<br>'
      + 'Статистика: скільки відкрили, скільки перейшли, скільки купили після розсилки.</span>'
      + '</div>'
      + '<div style="background:#fefce8;border:1px solid #fde68a;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#854d0e;font-size:.82rem;">ЛІДМАГНІТИ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Безкоштовні матеріали в обмін на контакт: чекліст, PDF-гайд, відеоурок, розрахунок вартості.<br>'
      + 'Форма на сайті → автоматично в CRM як лід → автоматична email-розсилка з матеріалом.</span>'
      + '</div>'
      + '</div>'
      + '<b>Результат:</b> через місяць роботи бачите точні цифри — з Instagram конверсія 8%, з Google — 15%, з рекомендацій — 40%. Переносите бюджет туди де працює.'
      + AI_BTN,
    tasks: [
        { id:'m1', text:'Відкрити Бізнес → Маркетинг → Джерела трафіку', detail:'Створіть 3-5 джерел які ви використовуєте: Instagram Ads, Google Ads, Facebook, Органіка, Партнери, Рекомендації.' },
        { id:'m2', text:'Згенерувати UTM-посилання для кожного джерела', detail:'Оберіть джерело → «Згенерувати UTM» → скопіюйте посилання → використовуйте в рекламі замість звичайного посилання на сайт.' },
        { id:'m3', text:'Відкрити CRM і вручну додати джерело до 3-5 існуючих клієнтів', detail:'Клієнти → відкрити картку → поле «Джерело» → оберіть звідки прийшов. Так система почне збирати статистику.' },
        { id:'m4', text:'Переглянути звіт «Звідки клієнти» в Маркетинг → Аналітика', detail:'Після заповнення джерел в CRM тут з\'явиться розподіл: скільки лідів з кожного каналу, конверсія в угоду, середній чек.' },
        { id:'m5', text:'Додати витрати на рекламу у Фінанси з категорією "Маркетинг"', detail:'Фінанси → Витрати → категорія OPEX «Маркетинг». Витратили 10,000 на Instagram Ads — внесіть транзакцію. Система порахує ROI.' },
        { id:'m6', text:'Переглянути ROI по каналах за останній місяць', detail:'Маркетинг → ROI. Формула: (Дохід від каналу − Витрати на канал) ÷ Витрати × 100%. Якщо Instagram ROI = 250% — канал окупається втричі.' },
    ],
    action: { label:'Відкрити маркетинг', tab:'marketing' },
    tip: INFO_ICON + ' Перші 2 тижні джерела заповнюйте вручну для існуючих клієнтів. Нові ліди з UTM-посилань підхоплюються автоматично. Через місяць — перші висновки.',
},
{
    id: 'bots', block: 'business', color: '#3b82f6',
    ...
    title: 'Telegram-боти: автоматизація спілкування і збір лідів', subtitle: 'Блок 8 · Бізнес', est: '20 хв',
    description: '<b>Біль без цього:</b> дзвінки пропущені, повідомлення в Telegram без відповіді, клієнт пише о 23:00 — ніхто не відповідає → втрачені ліди.<br><br>'
      + '<b>Що таке бот:</b> Telegram-бот працює 24/7, відповідає миттєво, збирає контакти, кваліфікує ліда (бюджет, термін, що потрібно), передає дані в CRM автоматично.<br><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#1e40af;font-size:.82rem;">КОНСТРУКТОР БЕЗ КОДУ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Drag & drop блоки: <b>Повідомлення</b> (текст + кнопки), <b>Запитання</b> (чекай відповідь користувача), <b>Умова</b> (якщо відповідь = А → один сценарій, якщо Б → інший).<br>'
      + 'Приклад сценарію: Привітання → «Що вас цікавить?» [кнопки: Послуга А, Послуга Б, Ціни] → збір імені → збір телефону → «Дякуємо, ми зателефонуємо за 15 хвилин» → <b>лід автоматично в CRM</b>.</span>'
      + '</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#166534;font-size:.82rem;">ІНТЕГРАЦІЯ З CRM</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Бот зібрав ім\'я, телефон, запит → автоматично створює лід в CRM з полями: джерело «Telegram-бот», ім\'я, контакт, коментар (що писав клієнт).<br>'
      + 'Менеджер одразу отримує сповіщення → дзвонить клієнту протягом 15 хвилин → конверсія в 3 рази вища ніж при затримці.</span>'
      + '</div>'
      + '<div style="background:#fef3c7;border:1px solid #fde68a;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#92400e;font-size:.82rem;">АВТОВІДПОВІДІ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Тригер-слова: клієнт пише «Ціна» → бот одразу відповідає прайсом.<br>'
      + 'FAQ: «Графік роботи», «Адреса», «Доставка» → бот відповідає автоматично, не відволікає команду.</span>'
      + '</div>'
      + '<div style="background:#fdf4ff;border:1px solid #e9d5ff;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#6b21a8;font-size:.82rem;">МЕНЮ БОТА</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Кнопки внизу екрана Telegram: «Послуги», «Ціни», «Контакти», «Залишити заявку».<br>'
      + 'Клієнт завжди бачить що може зробити → не треба пам\'ятати команди.</span>'
      + '</div>'
      + '</div>'
      + '<b>Типовий результат:</b> бот обробляє 60% звернень без участі людини. З 100 звернень 40 кваліфікованих лідів потрапляють в CRM автоматично.'
      + AI_BTN,
    tasks: [
        { id:'bot1', text:'Створити бот через @BotFather в Telegram', detail:'Відкрийте @BotFather → /newbot → введіть назву → отримаєте токен. Скопіюйте токен — він потрібен для підключення.' },
        { id:'bot2', text:'Підключити бот в TALKO: Боти → «+ Новий бот» → вставити токен', detail:'Боти → «+ Новий бот» → назва → токен від @BotFather → зберегти. Бот одразу активний.' },
        { id:'bot3', text:'Створити перший сценарій: Привітання + Збір імені + Збір телефону', detail:'Бот → «Сценарії» → «+ Новий» → Drag&drop: 1) Повідомлення «Вітаємо!», 2) Запитання «Як вас звати?», 3) Запитання «Ваш телефон?», 4) Повідомлення «Дякуємо, зателефонуємо!».' },
        { id:'bot4', text:'Налаштувати інтеграцію з CRM: автоматичне створення ліда', detail:'Бот → Налаштування → «Створювати лід в CRM після завершення сценарію» → увімкнути. Тепер кожна заповнена форма = лід.' },
        { id:'bot5', text:'Протестувати бот: напишіть йому в Telegram і пройдіть сценарій', detail:'Знайдіть свого бота в Telegram → /start → пройдіть весь сценарій → перевірте чи з\'явився лід в CRM → Клієнти або Угоди.' },
        { id:'bot6', text:'Налаштувати автовідповіді на 3 типові питання', detail:'Бот → Автовідповіді → «+ Нова» → тригер-слово «ціна» → текст відповіді з прайсом. Додайте «графік», «адреса», «доставка».' },
    ],
    action: { label:'Відкрити боти', tab:'bots' },
    tip: INFO_ICON + ' Перший бот створюється за 20 хвилин. Навіть простий сценарій (привітання + контакт) вже збирає ліди поки ви спите. Покращуйте поступово.',
},
{
    id: 'sites', block: 'business', color: '#8b5cf6',
    ...
    title: 'Конструктор сайтів: landing page за 30 хвилин', subtitle: 'Блок 8 · Бізнес', est: '25 хв',
    description: '<b>Біль без цього:</b> немає сайту — надсилаєте клієнтам PDF, текст в месенджері, Instagram-сторінку. Виглядає непрофесійно, складно оновлювати, неможливо відстежити звідки прийшли.<br><br>'
      + '<b>Що таке конструктор:</b> створюєте landing page без програміста за 30 хвилин. Готові блоки: заголовок, переваги, відгуки, галерея, форма заявки. Drag & drop. Форма → автоматично в CRM.<br><br>'
      + '<div style="display:grid;gap:8px;margin:8px 0;">'
      + '<div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#075985;font-size:.82rem;">ГОТОВІ ШАБЛОНИ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Оберіть шаблон (послуги, товари, студія, консультація) → змініть текст, фото, кольори → опублікувати.<br>'
      + 'Шаблони адаптовані під мобільні — 70% трафіку з телефонів, все працює коректно.</span>'
      + '</div>'
      + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#166534;font-size:.82rem;">ФОРМИ → CRM АВТОМАТИЧНО</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Додайте блок «Форма заявки» на сайт → поля: Ім\'я, Телефон, Email, Коментар.<br>'
      + 'Клієнт заповнює → <b>автоматично створюється лід в CRM</b> з джерелом «Сайт [назва сторінки]».<br>'
      + 'Менеджер одразу отримує Telegram-нотифікацію → дзвонить за 15 хвилин → конверсія максимальна.</span>'
      + '</div>'
      + '<div style="background:#fef3c7;border:1px solid #fde68a;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#92400e;font-size:.82rem;">ДОМЕН І ПУБЛІКАЦІЯ</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">За замовчуванням: yoursite.talko.page (безкоштовно).<br>'
      + 'Власний домен: підключіть your-company.com через налаштування DNS (інструкція в системі, 10 хвилин).</span>'
      + '</div>'
      + '<div style="background:#fdf4ff;border:1px solid #e9d5ff;border-radius:8px;padding:9px 12px;">'
      + '<b style="color:#6b21a8;font-size:.82rem;">SEO І АНАЛІТИКА</b><br>'
      + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Заповніть meta tags: заголовок, опис, ключові слова → Google індексує сторінку.<br>'
      + 'Аналітика: скільки відвідувачів, скільки заповнили форму, конверсія % (відвідувачі → заявки).</span>'
      + '</div>'
      + '</div>'
      + '<b>Типовий результат:</b> landing page за 30 хвилин. 100 відвідувачів → 8-12 заявок в CRM автоматично. UTM-мітки показують звідки трафік.'
      + AI_BTN,
    tasks: [
        { id:'s1', text:'Відкрити Бізнес → Сайти → «+ Новий сайт»', detail:'Оберіть шаблон (послуги, продукт, консультація). Попередній перегляд — бачите як виглядає.' },
        { id:'s2', text:'Змінити текст і фото в 3 блоках: Заголовок, Переваги, Форма', detail:'Клік на блок → редагувати текст. Фото: завантажте своє або оберіть з бібліотеки (безкоштовні stock-фото вбудовані).' },
        { id:'s3', text:'Налаштувати форму заявки: Ім\'я, Телефон, Коментар', detail:'Блок «Форма» → Налаштування → оберіть які поля показувати. Мінімум: Ім\'я + Телефон (2 поля — конверсія вища).' },
        { id:'s4', text:'Увімкнути інтеграцію Форма → CRM', detail:'Форма → Налаштування → «Створювати лід в CRM» → увімкнути. Кожна заявка стає лідом з джерелом «Сайт».' },
        { id:'s5', text:'Опублікувати сайт і отримати посилання', detail:'Кнопка «Опублікувати» → ваше посилання: yourname.talko.page. Скопіюйте і відправте клієнту або використайте в рекламі.' },
        { id:'s6', text:'Заповнити SEO: заголовок сторінки, опис, ключові слова', detail:'Налаштування → SEO → Title (до 60 символів), Description (до 160), Keywords. Google побачить сторінку через 1-3 дні.' },
        { id:'s7', text:'Протестувати форму: заповніть сами і перевірте чи з\'явився лід', detail:'Відкрийте опублікований сайт → заповніть форму → перевірте CRM → Клієнти або Угоди → має з\'явитись новий лід.' },
    ],
    action: { label:'Відкрити сайти', tab:'sites' },
    tip: INFO_ICON + ' Перший landing робіть простим: заголовок, 3 переваги, форма. Все. Не перевантажуйте. Після 100 відвідувачів — дивіться аналітику і покращуйте.',
},
