...
window._DEMO_NICHE_MAP['construction_eu'] = async function() {
    ...
    const TASKS = [
        ...
        { t:'Перевірити KPI тижня — виручка, об\'єкти, команда',        fi:7, ai:0,  st:'new',      pr:'high',   d:0,  tm:'09:00', est:30,  r:'KPI зафіксовані, відхилення визначені' },
        { t:'Узгодити кошторис з клієнтом Данченко (380К)',             fi:1, ai:0,  st:'new',      pr:'high',   d:0,  tm:'11:00', est:45,  r:'Кошторис підписаний або правки зафіксовані' },
        { t:'Контроль об\'єкту Петренків — огляд якості',               fi:6, ai:0,  st:'new',      pr:'high',   d:0,  tm:'14:00', est:60,  r:'Звіт по якості, фото, список доробок' },
        { t:'Підписати договір з новим постачальником плитки',          fi:4, ai:0,  st:'progress', pr:'medium', d:0,  tm:'16:00', est:30,  r:'Договір підписаний, умови зафіксовані' },
        { t:'Зустріч з інвестором — об\'єкт на Хрещатику',             fi:7, ai:0,  st:'new',      pr:'high',   d:-1, tm:'10:00', est:90,  r:'Презентація проведена, наступний крок визначений' },
        // Сьогодні — решта команди
