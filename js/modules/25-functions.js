...
'use strict';
        ...
        function updateFunctionAssignees() {
            ...
            if (t) t.innerHTML = `${window.t('optionValueНетOption')}` + userOptions;
            ...
            if (rt) {
                ...
                rt.innerHTML = `${window.t('optionValueНеПодчиняется')}` +
        ...
        function renderFunctions() {
            ...
            c.innerHTML = activeFunctions.map(f => {
                ...
                const statusBadge = f.status === 'draft'
                    ? `${window.t('spanStylefontsize07rembackgroundf3f4f6co')}`
                    : '';
            ...
            const steps = [
                ...
                },
                {
                    ...
                    content: ownerUser
                        ...
                        : `${window.t('pStylecoloref4444displayflexalignitemsce')}`
                },
                {
                ...
                },
                {
                    ...
                    content: reportsToFunc
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280функцияНе')}`
                },
                {
                    ...
                    content: f.communicatesWith?.length
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280коммуника')}`
                },
                {
                    num: 6, icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>', title: window.t('fnHowtoReplace2t'),
                    content: funcRegularTasks.length
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280регулярны')}`
                },
                {
                    num: 7, icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>', title: window.t('firstTasks'),
                    content: funcTasks.length
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280активныхЗ')}`
                },
                {
                    ...
                    content: funcLessons.length
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280перейдиВР')}`
                },
                {
                    ...
                    content: funcUsers.length
                        ...
                        : `${window.t('pStylefontsize085remcolor6b7280участнико')}`
                }
            ];
