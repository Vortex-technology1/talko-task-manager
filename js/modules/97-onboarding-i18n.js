...
window.OB_I18N.ru.finance_full_overview = {
  title: 'Финансы: полный обзор возможностей', subtitle: 'Блок 7 · Финансы', est: '15 мин',
  actionLabel: 'Открыть финансы',
  description: '<b>Прочитайте перед началом.</b> Финансовый модуль — это не бухгалтерская программа. Это управленческий инструмент владельца: видеть где деньги, куда уходят, когда будет разрыв, и что мешает росту прибыли.<br><br>'
    + '<div style="background:#ecfdf5;border:1.5px solid #6ee7b7;border-radius:10px;padding:10px 14px;margin:8px 0;">'
    + '<div style="font-size:.72rem;font-weight:700;color:#065f46;letter-spacing:.07em;margin-bottom:6px;">11 ВКЛАДОК — КАЖДАЯ ЗА СВОЁ</div>'
    ...
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Главный экран. Показывает: <b>Доход / Расходы / Прибыль / Маржа</b> за выбранный месяц с сравнением к предыдущему (↑↓%). SVG-график доходов и расходов за 6 месяцев — виден тренд и сезонность. Donut-диаграмма топ расходов по категориям. Топ проектов по марже — видите какие сделки реально прибыльны. Блок план/факт: выполнение бюджета текущего месяца в %. <b>Автоматические сигналы:</b> отрицательный остаток счёта, дебиторка свыше 30 дней, превышение бюджета категории.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">2. ДОХОДЫ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Список всех транзакций дохода. Фильтры: по счёту, категории, датам. Каждая транзакция: сумма, счёт, категория, дата оплаты, дата начисления (для P&L), комментарий, привязка к сделке CRM или проекту. <b>Перевод между счетами</b> — не считается доходом, только перемещает деньги. Экспорт в CSV и Excel одним кликом.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">3. РАСХОДЫ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Список расходов с теми же полями что и доходы. Важно: категория имеет тип <b>COGS</b> (себестоимость — прямая затрата на услугу) или <b>OPEX</b> (операционная — независимо от объёма). Это определяет структуру P&L: Выручка − COGS = Валовая прибыль − OPEX = Чистая прибыль. Сигнал при 80% и 100% использования месячного бюджета по категории.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">4. РЕГУЛЯРНЫЕ ПЛАТЕЖИ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Шаблоны для повторяющихся транзакций: аренда, зарплаты, подписки, кредиты. Настройка: сумма, счёт, категория, день месяца или недели, дата завершения. В назначенный день система <b>автоматически создаёт транзакцию</b> — не нужно вносить вручную каждый месяц. Можно поставить на паузу без удаления.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">5. СЧЕТА КЛИЕНТАМ (INVOICES)</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Выставляете счёт прямо из карточки сделки CRM — клиент и сумма подставляются автоматически. Позиции с количеством и ценой, скидка, НДС, примечания. PDF-счёт с реквизитами компании за 2 минуты. Статусы: Черновик → Отправлен → Частично оплачен → Оплачен → Просрочен. При статусе «Оплачен» → <b>транзакция дохода создаётся автоматически</b>. Онлайн-оплата через Stripe прямо из счёта. Список неоплаченных счетов = ваша текущая дебиторская задолженность.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">6. ФИНАНСЫ ПО ФУНКЦИЯМ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Привязка расходов и доходов к бизнес-функциям (департаментам). Видите сколько стоит каждая функция: маркетинг, производство, администрация, HR. Бюджет по каждой функции отдельно — контроль где перерасход. Это реализация системы 7 департаментов: каждая гривна привязана к функции.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">7. ПЛАНИРОВАНИЕ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Четыре режима: <b>Бюджет</b> — план/факт по категориям; <b>По функциям</b> — бюджет каждого департамента; <b>Cashflow прогноз</b> — прогноз остатка на 30/60/90 дней на основе регулярных платежей и текущих поступлений; <b>Еженедельный план 6M</b> — столбчатый график план/факт по каждой неделе на полгода, синяя линия cashflow, таблица с отклонениями, кнопка «Заполнить из среднего 3M». Видно где будет кассовый разрыв до того как он случится.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">8. АНАЛИТИКА</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;"><b>P&L отчёт:</b> полная структура с методом начисления — Выручка / Себестоимость / Валовая прибыль / OPEX / Чистая прибыль с % маржи по каждой строке. Сравнение месяцев, фильтр по счетам. <b>Cash Flow:</b> реальное движение денег по месяцам. <b>Маржинальность по проектам:</b> какая сделка сколько принесла чистого. <b>Тренд расходов по категориям:</b> как менялись расходы за 6 месяцев — видно где рост. Экспорт P&L в XLSX и PDF.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">9. БАЛАНС</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Классическая структура: <b>Активы</b> (деньги на счетах + дебиторка + запасы со склада + основные средства) / <b>Пассивы</b> (кредиторка + кредиты + прочие обязательства) / <b>Капитал</b> (собственный капитал бизнеса). Автоматически рассчитывается на основе транзакций. Настройка: можно добавить собственные строки (оборудование, недвижимость). Отвечает на вопрос: сколько на самом деле стоит бизнес.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">10. AI-АНАЛИТИК</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;">Задаёте вопрос текстом — AI отвечает на основе ваших реальных финансовых данных. Примеры: «Какие категории расходов выросли в этом месяце?», «Сравни прибыль с прошлым месяцем», «Хватит ли денег на зарплату на следующей неделе?», «Что съедает больше всего маржи?». Не общие советы — конкретные ответы по вашим цифрам.</div>'
    + '</div>'

    + '<div style="background:white;border-radius:7px;padding:7px 10px;border:1px solid #d1fae5;">'
    + '<div style="font-size:.8rem;font-weight:700;color:#059669;">11. НАСТРОЙКИ</div>'
    + '<div style="font-size:.78rem;color:#374151;line-height:1.5;margin-top:2px;"><b>Счета</b> — добавляете свои (банк, касса, карта, Stripe), начальные остатки, валюта. <b>Категории доходов и расходов</b> — с типом COGS/OPEX. <b>Связи с модулями</b> — toggles: CRM → Финансы, Booking → Финансы, Склад → Финансы. <b>Курсы валют</b> — если есть транзакции в разных валютах. <b>Реквизиты компании</b> для счетов (Invoice). <b>Права доступа</b> — кто видит финансы.</div>'
    + '</div>'
    ...
    + '<b>С чего начинать:</b> Настройки → Счета (начальные остатки) → Категории → первые 5 транзакций → дашборд оживёт. Всё остальное настраивается постепенно.'
    + '</div>',
  tipText: 'Цель этого шага — понимание возможностей. Не пытайтесь сразу всё настроить. Счета + категории + 5 транзакций = уже ценность.',
  tasks: [
    {text: 'Открыть Финансы и пройти по всем 11 вкладкам', detail: 'Потратьте 5 минут чтобы понять где что находится перед тем как начинать вносить данные.'},
    {text: 'Открыть Настройки → Счета и добавить свои счета с начальными остатками', detail: 'Минимум 2: наличные и банковский счёт. Введите реальные остатки на сегодня.'},
    {text: 'Открыть Настройки → Категории и настроить категории под свой бизнес', detail: 'Доходы: услуги, товары, абонементы. Расходы: материалы (COGS), аренда (OPEX), зарплата (OPEX).'},
    {text: 'Включить связи: CRM → Финансы и Booking → Финансы (если используете)', detail: 'Настройки → раздел «Связи между модулями» → включите нужные toggles.'},
    {text: 'Внести 5 реальных транзакций (доходы + расходы) и просмотреть дашборд', detail: 'После первых транзакций дашборд покажет KPI, график и топ расходов — это будет первое реальное финансовое фото бизнеса.'},
  ],
};

// ══ RU: 7 rewritten finance steps ══
window.OB_I18N.ru.finance_setup = {
  title: 'Шаг 1: Настройка — счета и категории', subtitle: 'Блок 7 · Финансы', est: '10 мин',
  actionLabel: 'Открыть настройки',
  description: '<b>Без этого не будет ничего.</b> Прежде чем вносить данные — нужно настроить два базовых элемента: счета (где лежат деньги) и категории (на что тратите и откуда получаете).<br><br>'
    ...
    + '<b style="color:#059669;font-size:.82rem;">СЧЕТА — ваши «кошельки»</b><br>'
    + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Каждая транзакция привязана к счёту. Типичная структура: Основной счёт (банк) + Касса (наличные).<br>'
    + 'Для каждого счёта указываете <b>начальный остаток</b> — реальная сумма на сегодня. Без этого cashflow будет неточным.</span>'
    + '</div>'
    + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
    + '<b style="color:#2563eb;font-size:.82rem;">КАТЕГОРИИ — структура P&L</b><br>'
    + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Категории доходов: Услуги, Товары, Абонементы.<br>'
    + 'Категории расходов имеют тип: <b>COGS</b> (себестоимость — растёт с каждым клиентом: материалы, зарплата мастеров) или <b>OPEX</b> (операционные — фиксированные: аренда, маркетинг, зарплата администрации).<br>'
    + 'Это разделение определяет структуру P&L и где искать проблему с маржой.</span>'
    + '</div>'
    + '</div>'
    + 'Тратите 10 минут сейчас → все следующие шаги дадут правильную аналитику.',
  tipText: 'Правило COGS vs OPEX: если завтра у вас вдвое больше клиентов — эта затрата вырастет? Если да — COGS. Если нет (аренда та же) — OPEX.',
  tasks: [
    {text: 'Открыть Финансы → Настройки → Счета', detail: 'Есть «Основной счёт» по умолчанию. Отредактируйте его и добавьте Кассу если есть наличные поступления.'},
    {text: 'Ввести начальный остаток для каждого счёта', detail: 'Редактируйте счёт → поле «Начальный остаток» → введите реальную сумму на сегодня. Это стартовая точка cashflow.'},
    {text: 'Настройки → Категории → добавить категории доходов', detail: 'Минимум: «Услуги» или название вашего основного продукта. Можно добавить несколько если есть разные потоки дохода.'},
    {text: 'Добавить категории расходов с типом COGS и OPEX', detail: 'COGS: материалы, зарплата исполнителей, подрядчики. OPEX: аренда, маркетинг, зарплата администрации, программы.'},
  ],
};

window.OB_I18N.ru.finance_first_data = {
  title: 'Шаг 2: Первые транзакции и дашборд', subtitle: 'Блок 7 · Финансы', est: '15 мин',
  actionLabel: 'Открыть финансы',
  description: '<b>Финансы без данных — красивый но пустой дашборд.</b> После первой транзакции система оживает: появляются KPI, графики, топ расходов.<br><br>'
    + '<b>Что такое транзакция и как вносить:</b><br>'
    + '<div style="display:grid;gap:6px;margin:8px 0;">'
    + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Обязательные поля:</b> Тип (Доход/Расход), Сумма, Счёт, Категория, Дата оплаты<br>'
    + '<b>Важно — Дата начисления:</b> если клиент заплатил в марте за услугу которая будет в апреле → Дата оплаты = март, Дата начисления = апрель. Cash Flow покажет деньги в марте, P&L — доход в апреле. Если обе даты одинаковые — поле можно не заполнять.</div>'
    + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Привязка к сделке CRM (необязательно):</b> если доход от конкретной сделки — привяжите. Тогда в аналитике будет видна маржа каждого проекта/сделки отдельно.</div>'
    + '</div>'
    + '<b>После 5+ транзакций дашборд покажет:</b> Доход / Расходы / Прибыль / Маржа за месяц, SVG-график 6 месяцев, топ категорий расходов.',
  tipText: 'Вносите транзакции минимум раз в неделю — 15 минут. Это единственное условие чтобы система давала полезную аналитику.',
  tasks: [
    {text: 'Внести 3 реальных дохода текущего месяца', detail: 'Финансы → Доходы → «+ Доход». Заполните: сумма, категория, счёт, дата.'},
    {text: 'Внести 3 реальных расхода с правильными категориями COGS/OPEX', detail: 'Финансы → Расходы → «+ Расход». Обязательно указывайте категорию с правильным типом — это основа P&L.'},
    {text: 'Просмотреть дашборд — проверить что KPI и график заполнились', detail: 'Дашборд обновляется автоматически. Если цифры неправильные — проверьте счёт и категорию транзакции.'},
    {text: 'Проверить блок «Остаток по счетам» на дашборде', detail: 'Сумма остатков по всем счетам = начальный остаток + доходы − расходы. Должна совпадать с реальностью.'},
  ],
};

window.OB_I18N.ru.finance_recurring = {
  title: 'Шаг 3: Регулярные платежи — автоматизация', subtitle: 'Блок 7 · Финансы', est: '10 мин',
  actionLabel: 'Открыть финансы',
  description: '<b>Аренда, зарплаты, подписки — каждый месяц одно и то же.</b> Настраиваете один раз → система создаёт транзакции автоматически в нужный день.<br><br>'
    + '<b>Что настраивается:</b><br>'
    + '<div style="display:grid;gap:6px;margin:8px 0;">'
    + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + 'Название, тип (доход/расход), сумма, счёт, категория<br>'
    + 'Частота: ежемесячно или еженедельно<br>'
    + 'День месяца или день недели когда создавать транзакцию<br>'
    + 'Дата завершения (если есть — например кредит до августа)<br>'
    + 'Можно поставить на паузу без удаления</div>'
    + '</div>'
    + '<b>Типичные регулярные платежи:</b> аренда помещения, зарплата (если фиксированная), хостинг, CRM-подписка, кредит, интернет, коммунальные.<br><br>'
    + '<b>Эффект:</b> через 2 недели система сама запишет все постоянные расходы. Видите реальную картину без ручного ввода каждый месяц.',
  tipText: 'Настройте все регулярные платежи до конца первой недели. Тогда уже со следующего месяца они будут появляться автоматически и расходы не потеряются.',
  tasks: [
    {text: 'Открыть Финансы → Регулярные платежи', detail: 'Здесь список всех шаблонов. Сначала пусто — добавьте первый.'},
    {text: 'Добавить аренду или другой постоянный ежемесячный платёж', detail: '«+ Новый» → название «Аренда» → тип «Расход» → сумма → счёт → категория OPEX → день месяца (например 5-го).'},
    {text: 'Добавить зарплату (если выплачиваете фиксированную сумму)', detail: 'Отдельно для каждого сотрудника или общим платежом — зависит от того нужна ли вам детализация по людям.'},
    {text: 'Проверить что в следующий день выплаты транзакция появится автоматически', detail: 'Или нажмите «Выполнить сейчас» если хотите внести за текущий месяц сразу.'},
  ],
};

window.OB_I18N.ru.finance_invoices_setup = {
  title: 'Шаг 4: Счета клиентам и автосвязи', subtitle: 'Блок 7 · Финансы', est: '10 мин',
  actionLabel: 'Открыть финансы',
  description: '<b>Два способа чтобы деньги от клиентов попадали в финансы автоматически — без двойного ввода.</b><br><br>'
    + '<div style="display:grid;gap:8px;margin:8px 0;">'
    + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;">'
    + '<b style="color:#059669;font-size:.82rem;">СПОСОБ 1: Счёт клиенту (Invoice)</b><br>'
    + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Открываете сделку в CRM → кнопка «Счёт» → клиент и сумма подставляются автоматически → добавляете позиции → PDF за 2 минуты → отправляете клиенту.<br>'
    + 'Когда клиент платит → меняете статус счёта на «Оплачен» → <b>транзакция дохода в финансах создаётся автоматически</b>.<br>'
    + 'Настройте реквизиты компании: Система → Настройки → Реквизиты.</span>'
    + '</div>'
    + '<div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:9px 12px;">'
    + '<b style="color:#2563eb;font-size:.82rem;">СПОСОБ 2: CRM → Финансы (автосвязь)</b><br>'
    + '<span style="font-size:.8rem;color:#374151;line-height:1.5;">Включите toggle в Настройках → Связи между модулями.<br>'
    + 'Теперь когда сделка в CRM переходит в статус «Выиграно» → система спрашивает «Записать доход в финансы?» → подтверждаете → транзакция создаётся автоматически с правильной суммой и категорией.<br>'
    + 'Так же: Booking → Финансы (оплаченная запись → авто-транзакция).</span>'
    + '</div>'
    + '</div>'
    + '<b>Список неоплаченных счетов</b> = ваша дебиторская задолженность. Видно кто и сколько вам должен.',
  tipText: 'Не давайте всем доступ к финансам. Менеджер видит сумму своей сделки — но не P&L компании. Настройте права: Система → Настройки → Роли.',
  tasks: [
    {text: 'Заполнить реквизиты компании для счетов', detail: 'Система → Настройки → Реквизиты компании: название, адрес, ИНН/ЕГРПОУ, банковские реквизиты. Заполните один раз — подставляются в каждый счёт.'},
    {text: 'Создать тестовый счёт из карточки CRM-сделки', detail: 'Откройте любую сделку → кнопка «Счёт» → добавьте 1-2 позиции → предпросмотр PDF → сохраните.'},
    {text: 'Отметить счёт как «Оплачен» и проверить что транзакция появилась', detail: 'Финансы → Счета → найдите тестовый → статус «Оплачен» → проверьте Доходы — должна появиться новая транзакция.'},
    {text: 'Включить автосвязи: CRM → Финансы и Booking → Финансы', detail: 'Система → Настройки → раздел «Связи между модулями» → включите нужные toggles. Протестируйте: закройте тестовую сделку.'},
  ],
};

window.OB_I18N.ru.finance_cashflow = {
  title: 'Отчёт 1: Cash Flow — где деньги сейчас', subtitle: 'Блок 7 · Финансы', est: '15 мин',
  actionLabel: 'Открыть аналитику',
  description: '<b>Cash Flow отвечает на один вопрос: есть ли деньги прямо сейчас и когда они придут?</b><br><br>'
    + 'Бизнес может показывать прибыль по P&L — но иметь ноль на счету. Это нормально если клиенты платят с задержкой. Cash Flow показывает реальность.<br><br>'
    + '<div style="display:grid;gap:6px;margin:8px 0;">'
    + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Где найти:</b> Финансы → Аналитика → Cash Flow<br>'
    + '<b>Что показывает:</b> график реального движения денег по месяцам — сколько пришло и сколько ушло. Остаток на конец каждого месяца.</div>'
    + '<div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Cash Flow vs P&L — разница:</b><br>'
    + 'Клиент заплатил 50,000 предоплаты в марте за работу которая будет в апреле.<br>'
    + 'Cash Flow март: +50,000 (деньги пришли)<br>'
    + 'P&L март: 0 (услуга ещё не оказана)<br>'
    + 'P&L апрель: +50,000 (услуга оказана)<br>'
    + 'Именно для этого есть поле «Дата начисления» в транзакции.</div>'
    + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Еженедельный план 6M (прогноз):</b> Финансы → Планирование → «Еженедельный план 6M»<br>'
    + 'График план/факт по каждой неделе на полгода. Синяя линия = накопительный остаток. Если линия идёт ниже нуля — кассовый разрыв. Видите его за 2-3 недели до того как он случится.</div>'
    + '</div>'
    + '<b>Еженедельная рутина (15 минут):</b> внести поступления недели → сверить с планом → если отклонение больше 20% → скорректировать план следующей недели.',
  tipText: 'Cash Flow — первый отчёт который открывайте каждый понедельник. 2 минуты: сколько пришло, сколько ушло, сколько осталось.',
  tasks: [
    {text: 'Открыть Финансы → Аналитика → Cash Flow', detail: 'Если данных нет — сначала внесите транзакции за несколько недель. График строится автоматически.'},
    {text: 'Сравнить остаток Cash Flow с реальным остатком счетов', detail: 'Цифра «Остаток» в Cash Flow должна совпадать с суммой по всем счетам на дашборде. Если разница — проверьте внесены ли все транзакции и правильны ли начальные остатки.'},
    {text: 'Открыть Планирование → Еженедельный план 6M и настроить', detail: 'Укажите начальный остаток → нажмите «Заполнить из среднего 3M» → скорректируйте недели где планируете больше или меньше продаж.'},
    {text: 'Найти неделю где cashflow линия падает ниже нуля и скорректировать план', detail: 'Если есть такая неделя — или увеличьте плановый доход (запланированные сделки) или уменьшите расходы. Это и есть управление ликвидностью.'},
    {text: 'Внести транзакцию с разными датами оплаты и начисления', detail: '«+ Доход» → Дата оплаты = сегодня, Дата начисления = следующий месяц. Проверьте что в Cash Flow транзакция в этом месяце, а в P&L — в следующем.'},
  ],
};

window.OB_I18N.ru.finance_pl = {
  title: 'Отчёт 2: P&L — зарабатывает ли бизнес', subtitle: 'Блок 7 · Финансы', est: '15 мин',
  actionLabel: 'Открыть аналитику',
  description: '<b>P&L (Прибыли и убытки) отвечает на вопрос: прибыльный ли мой бизнес и где теряется маржа?</b><br><br>'
    + 'В отличие от Cash Flow — P&L показывает не когда пришли деньги, а когда оказана услуга. Это реальная картина прибыльности.<br><br>'
    + '<div style="display:grid;gap:6px;margin:8px 0;">'
    ...
    + 'Выручка (все доходы)<br>'
    + '− COGS (себестоимость) = <b>Валовая прибыль + Валовая маржа %</b><br>'
    + '− OPEX (операционные расходы) = <b>Чистая прибыль + Чистая маржа %</b><br><br>'
    + 'Норма для сервисного бизнеса: Валовая маржа 50-70%, Чистая маржа 20-35%.</div>'
    + '<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Где найти:</b> Финансы → Аналитика → P&L отчёт<br>'
    + '<b>Фильтры:</b> по месяцам, сравнение месяцев, по счетам.<br>'
    + '<b>Маржинальность по проектам:</b> отдельная вкладка — какая сделка/проект сколько принёс чистого.<br>'
    + '<b>Тренд расходов:</b> как менялись расходы по категориям за 6 месяцев.<br>'
    + '<b>Экспорт:</b> XLSX и PDF одним кликом.</div>'
    + '<div style="background:#fef9c3;border:1px solid #fde68a;border-radius:8px;padding:8px 12px;font-size:.8rem;">'
    + '<b>Типичная диагностика:</b><br>'
    + 'Если Валовая маржа нормальная (60%) но Чистая маржа маленькая (5%) → проблема в OPEX (слишком большие операционные расходы).<br>'
    + 'Если Валовая маржа маленькая (20%) → проблема в COGS (высокая себестоимость или слишком низкая цена).</div>'
    + '</div>'
    + '<b>Ежемесячная рутина:</b> первый рабочий день месяца → P&L за прошлый месяц → сравнить с предыдущим → найти отклонения больше 10% → разобраться почему.',
  tipText: 'Смотрите P&L каждый месяц — первый день нового месяца. 10 минут: выручка, маржа, где выросли расходы. Если цифра удивила — разбираетесь до конца недели.',
  tasks: [
    {text: 'Открыть Финансы → Аналитика → P&L отчёт', detail: 'Выберите текущий месяц. Если категории настроены правильно с COGS/OPEX — увидите полную структуру с маржой.'},
    {text: 'Проверить валовую маржу — она выше 40%?', detail: 'Если ниже — или слишком низкая цена или высокая себестоимость. Сравните с прошлым месяцем.'},
    {text: 'Открыть вкладку «Маржинальность по проектам»', detail: 'Здесь видно какие сделки/проекты реально прибыльны. Часто оказывается что 20% клиентов дают 80% прибыли.'},
    {text: 'Сравнить P&L двух месяцев', detail: 'Аналитика → P&L → изменить фильтр на «Сравнение». Где выручка выросла а прибыль упала — там нужно искать причину.'},
    {text: 'Экспортировать P&L в Excel или PDF', detail: 'Кнопка «Экспорт» → XLSX или PDF. Сохраняйте ежемесячно как архив.'},
  ],
};

window.OB_I18N.ru.finance_balance = {
  title: 'Отчёт 3: Баланс — сколько стоит бизнес', subtitle: 'Блок 7 · Финансы', est: '15 мин',
  actionLabel: 'Открыть баланс',
  description: '<b>Баланс отвечает на вопрос: сколько на самом деле стоит мой бизнес и сколько я должен?</b><br><br>'
    + 'Cash Flow = где деньги сейчас. P&L = прибыльный ли бизнес. Баланс = сколько стоит весь бизнес как актив.<br><br>'
    + '<div style="display:grid;gap:6px;margin:8px 0;">'
    + '<div style="background:#faf5ff;border:1px solid #e9d5ff;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
    + '<b style="color:#7c3aed;">АКТИВЫ (что у вас есть)</b><br>'
    + 'Деньги на счетах — автоматически из финансов<br>'
    + 'Дебиторская задолженность — неоплаченные счета клиентов<br>'
    + 'Остатки на складе — автоматически со Склада<br>'
    + 'Основные средства — оборудование, авто, недвижимость (добавляете вручную)</div>'
    + '<div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
    + '<b style="color:#dc2626;">ПАССИВЫ (что вы должны)</b><br>'
    + 'Кредиторская задолженность — что вы должны поставщикам<br>'
    + 'Кредиты и займы — тело долга<br>'
    + 'Прочие обязательства (добавляете вручную)</div>'
    + '<div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:9px 12px;font-size:.8rem;">'
    + '<b style="color:#059669;">КАПИТАЛ = АКТИВЫ − ПАССИВЫ</b><br>'
    + 'Это реальная стоимость вашего бизнеса. Если капитал растёт месяц к месяцу — бизнес развивается.'
    + '</div>'
    + '</div>'
    + '<b>Настройка баланса:</b> Финансы → Баланс → кнопка «Настройки». Добавьте основные средства (оборудование), кредиты, кредиторку — эти строки система не знает автоматически.<br><br>'
    + '<b>Ежеквартальная рутина:</b> раз в квартал → Баланс → сравнить Капитал с предыдущим кварталом → если вырос — бизнес стоит больше → если упал — ищете причину.',
  tipText: 'После настройки баланса у вас есть полная финансовая картина. Cash Flow еженедельно + P&L ежемесячно + Баланс ежеквартально = финансовый контроль без бухгалтера.',
  tasks: [
    {text: 'Открыть Финансы → Баланс', detail: 'Увидите три секции: Активы, Пассивы, Капитал. Часть заполнена автоматически (счета, дебиторка). Часть требует ручной настройки.'},
    {text: 'Нажать «Настройки» и добавить основные средства', detail: 'Оборудование, автомобили, недвижимость — то чем бизнес владеет но это не деньги на счету. Текущая рыночная или балансовая стоимость.'},
    {text: 'Добавить кредиты и обязательства если есть', detail: 'Остаток по кредиту, задолженность перед поставщиками. Это пассивы — уменьшают реальную стоимость бизнеса.'},
    {text: 'Проверить сумму Капитала — это реальная стоимость вашего бизнеса', detail: 'Капитал = Активы − Пассивы. Запомните эту цифру. Ежеквартально сверяйте — растёт ли?'},
    {text: 'Понять связь трёх отчётов', detail: 'Cash Flow: есть деньги сейчас? P&L: прибыльный ли? Баланс: сколько стоит? Три вопроса — три ответа. Теперь вы управляете бизнесом цифрами, а не ощущениями.'},
  ],
};
