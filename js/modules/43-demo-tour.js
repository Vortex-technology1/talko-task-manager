...
food_production: [
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg> Мій день — Галина знає план, Микола знає що варити',
        selector: '#mydayTab, [onclick*="switchTab(\'myday\')"]',
        tab: 'myday',
        pitch: 'Галина (технолог) відкрила систему о 7:30 і бачить:<br><br>• Зготовити 100 порцій борщу до 10:30 — для Кейтеринг Плюс (60) і СмакО (40)<br>• Зготовити 80 бізнес-ланчів до 11:30 — для TechHub<br>• Перевірити температурні журнали HACCP о 7:00<br><br>Микола (кухар) відкрив свій телефон — бачить ті самі задачі. Жодного дзвінка "що робити сьогодні". Ірина (менеджер) знає: виставити рахунок лікарні до 9:00, переговори по школі о 10:00.<br><br>Три різних людини — один ранок — кожен знає свій план.',
        question: 'Як зараз ваш технолог і кухарі дізнаються що і скільки виробляти щоранку? Скільки дзвінків і повідомлень відбувається до 8:00?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Завдання — жодна задача не загубиться',
        selector: '[onclick*="switchTab(\'tasks\')"]',
        tab: 'tasks',
        pitch: 'Ось що в системі на сьогодні:<br><br>🔴 <b>В роботі:</b><br>• Борщ 100 порцій до 10:30 — Оксана (кухар перші страви)<br>• Бізнес-ланч 80 комплектів до 11:30 — Микола<br><br>✅ <b>Виконано:</b><br>• Котлети 50 порцій для лікарні — доставлено о 9:00<br><br>⚠️ <b>Прострочені:</b><br>• Магазин Марченко — не домовились про збільшення хліба з 15 до 25 буханок (2 дні)<br><br>Власник бачить це в телефоні без дзвінків. Технолог не тримає все в голові.',
        question: 'Де зараз фіксуються задачі вашого виробництва? Хтось веде список? Чи буває що задачу забули або "загубили"?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg> Прострочені — система показує де горить',
        selector: '#tasksTab',
        tab: 'tasks',
        pitch: 'Ось прострочена задача: <b>Магазин Марченко — збільшити хліб до 25 буханок</b>. Прострочена 2 дні.<br><br>Що це означає? Клієнт чекає підтвердження. Якщо Тетяна (менеджер) не передзвонить сьогодні — він може піти до конкурента.<br><br>Ще прострочене: <b>Оновити технологічну карту котлет</b> — нові норми МОЗ. Виробництво поки працює за старою картою. Ризик для HACCP.<br><br>Власник бачить ці ризики одразу — не через тиждень коли проблема вже вибухнула.',
        question: 'Як зараз відстежуєте прострочені завдання? Хтось вам доповідає або самі виявляєте?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> Рецептури — собівартість кожної страви до копійки',
        selector: '#foodProductionTab, [onclick*=\"foodProduction\"]',
        tab: 'foodProduction',
        pitch: 'Ось борщ класичний — відкриємо рецептуру:<br><br><b>Інгредієнти на 100 порцій:</b><br>• Свинина 1.5 кг × 185 грн/кг = 27.75 грн<br>• Буряк 3 кг × 14 грн/кг = 4.20 грн<br>• Картопля 2.5 кг × 12 грн/кг = 3.00 грн<br>• Морква 0.8 кг × 16 грн/кг = 1.28 грн<br>• Капуста, цибуля, олія, сіль = ~5.43 грн<br><br><b>Собівартість: 4.82 грн/порція</b><br>Ціна продажу: 95 грн<br><b>Маржа: 95%</b><br><br>Шоколадний брауні: собівартість 31.17 грн, маржа 63%.<br>Хліб пшеничний: собівартість 26.20 грн, маржа 42%.<br><br>Ви точно знаєте на якій страві заробляєте більше. Не відчуваєте — знаєте.',
        question: 'Назвіть прямо зараз точну собівартість вашої найпопулярнішої страви. Не приблизно — з цінами на кожен інгредієнт. Скільки часу це займе?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="8.01" y2="14"/><line x1="12" y1="14" x2="12.01" y2="14"/></svg> План виробництва — що, скільки і хто робить сьогодні',
        selector: '#foodProductionTab, [onclick*=\"foodProduction\"]',
        tab: 'foodProduction',
        pitch: 'Ось план на сьогодні:<br><br>🟡 <b>Заплановано:</b><br>• Борщ класичний — 100 порцій (для Кейтеринг Плюс 60 + СмакО 40)<br>• Бізнес-ланч — 80 комплектів (TechHub, до 11:30)<br><br>🟠 <b>В роботі:</b><br>• Брауні шоколадний — 48 порцій (4 форми × 12)<br>• Хліб пшеничний — 30 буханок (розвезення о 7:30 — вже їдуть)<br><br>✅ <b>Готово:</b><br>• Котлети — 50 порцій (доставлено в лікарню о 9:00)<br><br>Галина відкрила систему і одразу бачить стан виробництва. Микола бачить своє. Без вайберу, без нотатника.',
        question: 'Як зараз плануєте виробництво? Дошка? WhatsApp? Як Микола знає скільки котлет робити і для якого клієнта?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg> Стоп-лист — знаєте про нестачу о 7:30, а не о 11:00',
        selector: '#warehouseTab, [onclick*=\"warehouse\"]',
        tab: 'warehouse',
        pitch: 'Хочете зробити 150 порцій борщу на завтра. Система перевіряє прямо зараз:<br><br>✅ Буряк: потрібно 4.5 кг — є 85 кг<br>✅ М'ясо свинина: потрібно 2.25 кг — є 68 кг<br>✅ Картопля: потрібно 3.75 кг — є 120 кг (8 мішків)<br>⚠️ Капуста: потрібно 3 кг — є 48 кг — майже ліміт<br>❌ <b>Борошно: є 12 мішків, але мінімум 20 — НИЖЧЕ ЛІМІТУ</b><br><br>Система показала це Тетяні о 7:30 — вона вже замовила. Борошно буде до обіду.<br><br>Порівняйте з альтернативою: Микола о 11:00 каже "нема борошна для хліба".',
        question: 'Скільки разів цього місяця виробництво зупинялось в процесі бо не вистачило інгредієнта? Яка ціна цього простою в гривнях і в нервах?',
    },
    {
        ...
        selector: '#warehouseTab, [onclick*=\"warehouse\"]',
        tab: 'warehouse',
        pitch: 'Виробили 100 порцій борщу. Тетяна натиснула <b>"Готово"</b> в плані виробництва.<br><br>Система автоматично списала зі складу:<br>• Свинина −1.5 кг (залишок 66.5 кг)<br>• Буряк −3 кг (залишок 82 кг)<br>• Картопля −2.5 кг (залишок 117.5 кг)<br>• Морква −0.8 кг (залишок 61.2 кг)<br>• Олія −0.3 л (залишок 47.7 л)<br><br><b>Жодного ручного введення.</b> Залишки актуальні в реальному часі.<br><br>Галина не веде окремий зошит. Склад не розходиться з реальністю.',
        question: 'Як зараз ведете облік витрат сировини? Скільки часу щодня? І коли останній раз залишки в обліку не збіглись з реальністю?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg> Процес виробництва — 8 кроків від замовлення до оплати',
        selector: '[onclick*="switchTab(\'processes\')"]',
        tab: 'processes',
        pitch: 'Ось стандарт "Виробництво та відвантаження":<br><br>1. <b>Отримання замовлення</b> — Тетяна, 20 хв<br>2. <b>Перевірка стоп-листа</b> — чи вистачить сировини?<br>3. <b>Постановка в план</b> — Галина призначає кухарів<br>4. <b>Закупівля якщо потрібно</b> — Сергій їде на ринок<br>5. <b>Виробництво</b> — Оксана/Микола/Ірина, по рецептурі<br>6. <b>Пакування та маркування</b> — дата, склад, кількість<br>7. <b>Відвантаження</b> — Сергій (водій), накладна підписана<br>8. <b>Виставлення рахунку</b> — Тетяна, протягом доби<br><br>Якщо Тетяна захворіла — новий менеджер відкриває систему і знає весь процес.',
        question: 'Що відбувається якщо ваш ключовий технолог або менеджер захворів? Де зберігаються стандарти виробництва — в голові чи в системі?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Клієнти — знаєте хто скільки приносить',
        selector: '#crmTab, [onclick*=\"crm\"]',
        tab: 'crm',
        lazyGroup: 'crm',
        pitch: 'Ось база клієнтів КухняПро:<br><br>🏆 <b>Мережа кафе "СмакО"</b> — 5 точок, 150 порцій/тиждень, 182 000 грн за рік. Платить вчасно.<br>🏥 <b>Лікарня №3</b> — держзамовлення, 96 000 грн/рік. Дієтичне меню.<br>🏢 <b>TechHub</b> — 80 бізнес-ланчів щодня, 128 000 грн/рік.<br>🎒 <b>Дитсадок №48</b> — 120 дітей, 48 000 грн/рік. Без горіхів!<br><br>В розробці: <b>Школа №145</b> — 380 обідів/день. Потенціал 285 000 грн/рік.<br><br>Ви бачите хто ваш найцінніший клієнт і куди рости.',
        question: 'Хто ваш найприбутковіший клієнт прямо зараз? Яка виручка від нього за рік? Скільки часу займе знайти цю цифру?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><line x1="16" y1="8" x2="8" y2="8"/><line x1="16" y1="12" x2="8" y2="12"/><line x1="12" y1="16" x2="8" y2="16"/></svg> Реалізація — рахунок за 2 хвилини',
        selector: '#salesTab, [onclick*=\"sales\"]',
        tab: 'sales',
        pitch: 'Ось рахунок для СмакО (тижневе замовлення):<br><br>• Борщ класичний — 150 порцій × 95 грн = 14 250 грн<br>• Котлета по-домашньому — 80 порцій × 75 грн = 6 000 грн<br>• Пюре картопляне — 80 порцій × 35 грн = 2 800 грн<br><br><b>Рахунок INV-2026-0002 — 23 050 грн</b><br><br>Тетяна створила його за 2 хвилини — обрала клієнта, вибрала позиції, натиснула "Виставити". Email відправлений автоматично.<br><br>СмакО оплатив → виручка автоматично у фінансах. Жодного ручного введення.',
        question: 'Скільки часу у вас займає виставити рахунок оптовому клієнту? І скільки часу від відвантаження до отримання грошей?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> Фінанси — P&L без бухгалтера',
        selector: '#financeTab, [onclick*=\"finance\"]',
        tab: 'finance',
        pitch: 'Квітень — підсумок:<br><br><b>Дохід:</b><br>• Кейтеринг Плюс: 74 400 грн<br>• СмакО (5 точок): 182 000 грн<br>• TechHub (80 ланчів/день): 128 000 грн<br>• Лікарня + дитсадок: 38 000 грн<br>• Магазин Марченко: 8 400 грн<br><b>Разом: 430 800 грн</b><br><br><b>Витрати:</b><br>• Сировина: 86 400 грн<br>• Зарплата 6 осіб: 38 000 грн<br>• Оренда цеху 120м²: 18 000 грн<br>• Пакування + комунальні: 13 200 грн<br><b>Разом: 155 600 грн</b><br><br><b>Прибуток: 275 200 грн (маржа 64%)</b><br><br>Власник відкриває телефон вранці — бачить це.',
        question: 'Ви зараз знаєте чистий прибуток за минулий місяць? За скільки часу ви його дізнаєтесь?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg> KPI — маржа по стравах росте щотижня',
        selector: '[onclick*="statistics"]',
        tab: 'statistics',
        lazyGroup: 'statistics',
        pitch: 'Ось динаміка KPI за 7 тижнів:<br><br>📈 <b>Виручка:</b> 32 400 → 46 200 грн/тиждень (+43%)<br>📈 <b>Кількість порцій:</b> 980 → 1 520/тиждень (+55%)<br>📈 <b>Середня маржа:</b> 58% → 68% (+10 пп)<br>📈 <b>Клієнтів активних:</b> 4 → 6 (+50%)<br><br>Що дало ріст маржі? Переключили фокус на борщ (маржа 95%) і скоротили хліб (маржа 42%).<br><br>Ціль наступного місяця: 2 000 порцій/тиждень і 8 клієнтів.',
        question: 'Які KPI ви відстежуєте зараз? Маржа по стравах, кількість порцій, активні клієнти — де ці дані і хто їх рахує?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 017 4.5v1A2.5 2.5 0 014.5 8A2.5 2.5 0 012 10.5v3A2.5 2.5 0 014.5 16A2.5 2.5 0 017 18.5v1a2.5 2.5 0 005 0v-1A2.5 2.5 0 0014.5 16A2.5 2.5 0 0117 13.5v-3A2.5 2.5 0 0014.5 8A2.5 2.5 0 0112 5.5v-1A2.5 2.5 0 009.5 2z"/><path d="M12 5.5v13"/><path d="M7 8.5h10"/><path d="M7 13.5h10"/></svg> AI — знає ваш бізнес і відповідає за 10 секунд',
        selector: '[onclick*="aiAssistant"], #aiAssistantBtn',
        tab: 'myday',
        pitch: 'AI знає що КухняПро виробляє готові страви для корпоративних клієнтів, що маржа борщу 95% а хліба 42%, що ціль — 2 000 порцій/тиждень і 8 клієнтів.<br><br>Ви питаєте: <i>"Чому виручка минулого тижня менша ніж позаминулого?"</i><br>AI відповідає: <i>"Лікарня замовила на 30% менше через свята. Рекомендую запропонувати СмакО збільшити обсяг борщу на 20 порцій — це дасть +1 900 грн."</i><br><br>Не загальні поради — конкретні рекомендації на основі ваших даних.',
        question: 'Уявіть що у вас є аналітик який завжди знає всі цифри і відповідає за 10 секунд. Яке перше питання ви б йому поставили?',
    },
    {
        title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 00-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/></svg> КухняПро на автопілоті — що через 65 днів',
        selector: '#mydayTab',
        tab: 'myday',
        pitch: 'За 65 днів впровадження:<br><br>✅ Галина відкриває систему о 7:30 — план уже є<br>✅ Микола знає що варити без дзвінків<br>✅ Склад актуальний — нестача виявляється о 7:30, не о 11:00<br>✅ Рахунок виставляється за 2 хвилини<br>✅ Власник бачить P&L вранці в телефоні<br>✅ Школа №145 підписала контракт — 380 обідів/день<br><br>Ви не тушите пожежі — ви ростете.<br><br><b>КухняПро: 430 000 грн → 860 000 грн/місяць за рік.</b><br>Не прогноз — математика: +2 великих клієнти × поточний середній чек.',
        question: 'Як виглядає ваш бізнес через рік якщо кожен день є ця картина? Що змінюється для вас особисто?',
    },
],
],
...
food_production: [
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg> Мой день — Галина знает план, Николай знает что варить', pitch: 'Галина (технолог) открыла систему в 7:30:<br><br>• Приготовить 100 порций борща до 10:30 — для Кейтеринг Плюс (60) и СмакО (40)<br>• Приготовить 80 бизнес-ланчей до 11:30 — TechHub<br>• Проверить журналы HACCP в 7:00<br><br>Николай (повар) видит те же задачи в телефоне. Ни одного звонка.', question: 'Как сейчас технолог и повара узнают что производить каждое утро?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> Задачи — ни одна не потеряется', pitch: '🔴 <b>В работе:</b> Борщ 100 порций до 10:30 (Оксана), Бизнес-ланч 80 комплектов до 11:30 (Николай)<br><br>✅ <b>Выполнено:</b> Котлеты 50 порций для больницы — доставлено в 9:00<br><br>⚠️ <b>Просрочено:</b> Магазин Марченко — не договорились об увеличении хлеба (2 дня)<br><br>Владелец видит это в телефоне.', question: 'Где фиксируются задачи вашего производства? Бывало что задачу забыли?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> Рецептуры — себестоимость до копейки', pitch: '<b>Борщ классический (100 порций):</b><br>• Свинина 1.5 кг × 185 грн = 27.75 грн<br>• Свёкла 3 кг × 14 грн = 4.20 грн<br>• Картофель 2.5 кг × 12 грн = 3.00 грн<br>• Прочие = ~6.71 грн<br><b>Себестоимость: 4.82 грн/порция. Цена 95 грн. Маржа 95%.</b><br><br>Брауни: себестоимость 31.17 грн, маржа 63%.<br>Хлеб: маржа 42%.<br><br>Знаете на чём зарабатываете.', question: 'Назовите точную себестоимость вашего самого популярного блюда прямо сейчас.'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> План производства — что, сколько, кто', pitch: '🟡 <b>Запланировано:</b> Борщ 100 порций (Кейтеринг 60 + СмакО 40), Бизнес-ланч 80 комплектов<br>🟠 <b>В работе:</b> Брауни 48 порций, Хлеб 30 буханок (развозка в 7:30)<br>✅ <b>Готово:</b> Котлеты 50 порций — доставлено в больницу<br><br>Галина видит состояние производства. Николай видит своё. Без вайбера.', question: 'Как планируете производство на день? Как повар знает сколько котлет делать и для какого клиента?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg> Стоп-лист — знаете о нехватке в 7:30', pitch: 'Планируете 150 порций борща. Система проверяет:<br><br>✅ Свёкла 4.5 кг — есть 85 кг<br>✅ Мясо 2.25 кг — есть 68 кг<br>⚠️ Капуста — почти лимит<br>❌ <b>Мука: есть 12 мешков, минимум 20 — НИЖЕ ЛИМИТА</b><br><br>Татьяна увидела это в 7:30 — уже заказала. Мука будет к обеду.<br>Альтернатива: Николай в 11:00 говорит "нет муки".', question: 'Сколько раз в этом месяце производство останавливалось из-за нехватки ингредиента?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><polyline points="3.29 7 12 12 20.71 7"/><line x1="12" y1="22" x2="12" y2="12"/></svg> Автосписание — склад актуален без блокнота', pitch: 'Произвели 100 порций борща. Нажали <b>"Готово"</b>.<br><br>Система списала автоматически:<br>• Свинина −1.5 кг (остаток 66.5 кг)<br>• Свёкла −3 кг (остаток 82 кг)<br>• Картофель −2.5 кг (остаток 117.5 кг)<br><br><b>Никакого ручного ввода.</b> Галина не ведёт блокнот.', question: 'Как ведёте учёт расхода сырья? Когда последний раз остатки не совпали с реальностью?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg> Процесс — 8 шагов от заказа до оплаты', pitch: '1. Приём заказа — Татьяна<br>2. Проверка стоп-листа<br>3. Постановка в план — Галина<br>4. Закупка если нужно — Сергей<br>5. Производство по рецептуре<br>6. Упаковка и маркировка<br>7. Отгрузка — накладная<br>8. Выставление счёта<br><br>Если Татьяна заболела — новый менеджер открывает систему и знает процесс.', question: 'Что происходит если ваш ключевой технолог или менеджер заболел?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Клиенты — знаете кто сколько приносит', pitch: '🏆 <b>СмакО (5 точек)</b> — 150 порций/нед., 182 000 грн/год<br>🏥 <b>Больница №3</b> — 96 000 грн/год, диетическое меню<br>🏢 <b>TechHub</b> — 80 ланчей/день, 128 000 грн/год<br>🎒 <b>Детсад №48</b> — 120 детей, без орехов!<br><br>🎯 <b>В разработке: Школа №145</b> — 380 обедов/день, потенциал 285 000 грн/год', question: 'Кто ваш самый прибыльный клиент прямо сейчас? Сколько времени займёт найти эту цифру?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><line x1="16" y1="8" x2="8" y2="8"/><line x1="16" y1="12" x2="8" y2="12"/></svg> Реализация — счёт за 2 минуты', pitch: 'Счёт для СмакО (еженедельный):<br><br>• Борщ — 150 порций × 95 грн = 14 250 грн<br>• Котлета — 80 порций × 75 грн = 6 000 грн<br>• Пюре — 80 порций × 35 грн = 2 800 грн<br><b>Итого INV-2026-0002: 23 050 грн</b><br><br>Татьяна создала за 2 минуты. Email отправлен автоматически. Оплата → в финансах.', question: 'Сколько времени занимает выставить счёт оптовому клиенту?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> Финансы — P&L без бухгалтера', pitch: '<b>Апрель:</b><br>Доход: СмакО 182К + TechHub 128К + Кейтеринг 74К + остальные 46К = <b>430 800 грн</b><br>Расходы: сырьё 86К + зарплата 38К + аренда 18К + прочее 13К = <b>155 600 грн</b><br><br><b>Прибыль: 275 200 грн (маржа 64%)</b><br><br>Владелец открывает телефон утром — видит это.', question: 'Знаете чистую прибыль за прошлый месяц? За сколько времени вы её узнаете?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg> KPI — маржа растёт каждую неделю', pitch: 'Динамика за 7 недель:<br>📈 Выручка: 32 400 → 46 200 грн (+43%)<br>📈 Порции: 980 → 1 520/нед. (+55%)<br>📈 Средняя маржа: 58% → 68%<br>📈 Активных клиентов: 4 → 6<br><br>Рост маржи — переключили на борщ (95%) вместо хлеба (42%).', question: 'Какие KPI вы отслеживаете? Где эти данные и кто их считает?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 017 4.5v1A2.5 2.5 0 014.5 8A2.5 2.5 0 012 10.5v3A2.5 2.5 0 014.5 16A2.5 2.5 0 017 18.5v1a2.5 2.5 0 005 0v-1A2.5 2.5 0 0014.5 16A2.5 2.5 0 0117 13.5v-3A2.5 2.5 0 0014.5 8A2.5 2.5 0 0112 5.5v-1A2.5 2.5 0 009.5 2z"/><path d="M12 5.5v13"/><path d="M7 8.5h10"/><path d="M7 13.5h10"/></svg> AI — знает ваш бизнес', pitch: 'AI знает что КухняПро производит для корпоративных клиентов, что маржа борща 95% а хлеба 42%.<br><br>Вы спрашиваете: <i>"Почему выручка прошлой недели меньше?"</i><br>AI: <i>"Больница заказала на 30% меньше из-за праздников. Рекомендую СмакО +20 порций борща — это даст +1 900 грн."</i>', question: 'Представьте аналитика который знает все цифры и отвечает за 10 секунд. Какой первый вопрос?'},
    {title: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 00-2.91-.09z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/></svg> КухняПро на автопилоте — через 65 дней', pitch: '✅ Галина в 7:30 — план уже есть<br>✅ Николай знает что варить без звонков<br>✅ Склад актуален — нехватка выявляется в 7:30<br>✅ Счёт за 2 минуты<br>✅ P&L в телефоне утром<br>✅ Школа №145 подписала контракт — 380 обедов/день<br><br><b>430 000 → 860 000 грн/мес. за год.</b><br>Математика: +2 крупных клиента × текущий средний чек.', question: 'Как выглядит ваш бизнес через год если каждый день есть такая картина?'},
],
