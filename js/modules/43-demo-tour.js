...
furniture_factory: [
    ...
    { title:'⚠️ Отклонённые задачи — живой контроль',
    ...
    { title:'⚙️ Процессы — стандарт производства',
    ...
    { title:'📋 Процесс — 9 шагов от заявки до монтажа',
    ...
    { title:'📞 CRM Todo — звонки на сегодня',
    ...
    { title:'📊 Аналитика — 12 недель динамики',
    ...
    { title:'🏭 Система — 8 функций бизнеса',
    ...
    { title:'👥 Команда — загрузка каждого',
    ...
    { title:'📅 Регулярные платежи — ничего не забыто',
    ...
    { title:'📦 Склад — материалы под контролем',
    ...
    { title:'🔄 Склад — перемещения и инвентаризация',
    ...
    { title:'🏪 Поставщики — вся база в системе',
    ...
    { title:'📅 Бронирование — онлайн запись на замер',
    ...
    { title:'🤝 Координации — совещания с результатом',
    ...
    { title:'🧠 AI Ассистент — знает ваш бизнес',
    ...
    { title:'🚀 Что дальше — система на автопилоте',
