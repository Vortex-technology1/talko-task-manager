...
function _renderARModal() {
    ...
    if (!modal) {
        ...
        modal.style.cssText = `position:fixed;inset:0;z-index:10010;background:rgba(0,0,0,0.5);display:flex;align-items:flex-start;justify-content:center;padding-top:80px;padding-left:1rem;padding-right:1rem;padding-bottom:2rem;overflow-y:auto;`;
