...
const SITE_TEMPLATES = [
    ...
    },
    {
        ...
        color: '#f59e0b',
        html: `<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Мастер-класс для строительного бизнеса</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet"><style>:root{--green:#22c55e;--green-dark:#16a34a;--bg:#0a0f0a;--gray:#64748b;--light:#94a3b8;--red:#ef4444;--blue:#0088cc;--gold:#fbbf24}*{margin:0;padding:0;box-sizing:border-box}html{scroll-behavior:smooth}body{font-family:'Inter',sans-serif;background:#fff;color:#1a1a1a;line-height:1.6;font-size:16px}.wrap{max-width:640px;margin:0 auto;padding:0 20px}.btn{display:block;width:100%;padding:16px 20px;border-radius:12px;font-weight:700;font-size:16px;text-decoration:none;text-align:center;cursor:pointer;border:none}.btn-tg{background:var(--blue);color:#fff}.hero{background:var(--bg);padding:44px 0 52px;position:relative;overflow:hidden}.hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 90% 55% at 50% -10%,rgba(34,197,94,0.13),transparent);pointer-events:none}.hero-in{position:relative}.hero h1{font-size:clamp(22px,6vw,34px);font-weight:800;color:#fff;line-height:1.25;margin-bottom:14px}.hero-sub{font-size:clamp(15px,4vw,20px);font-weight:600;color:#94a3b8;line-height:1.4;margin-bottom:22px}.hero-sub .hl{color:var(--green);font-weight:700}.gold-box{background:rgba(251,191,36,0.07);border:1px solid rgba(251,191,36,0.28);border-radius:14px;padding:18px;margin-bottom:22px}.gold-box-label{font-size:11px;font-weight:700;color:#a8783a;text-transform:uppercase;letter-spacing:.6px;margin-bottom:12px}.gold-box li{list-style:none;font-size:15px;color:#d1d5db;padding:5px 0}.gold-box li .g{color:var(--gold);font-weight:700}.hero-note{font-size:14px;color:#6b7e8a;line-height:1.6;margin-bottom:18px}.hero-desc{font-size:15px;color:#8da0ad;line-height:1.7;margin-bottom:28px}.hero-desc strong{color:#d1d5db}.morning{background:#0d1a0d;border:1px solid rgba(34,197,94,0.2);border-radius:14px;padding:18px;margin:18px 0}.morning-label{font-size:11px;font-weight:700;color:#4a7a5a;text-transform:uppercase;letter-spacing:.6px;margin-bottom:12px}.morning-row{display:flex;gap:12px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,0.05)}.morning-row:last-child{border-bottom:none}.morning-time{font-size:12px;font-weight:700;color:var(--green);white-space:nowrap;min-width:44px;padding-top:2px}.morning-text{font-size:13px;color:#94a3b8;line-height:1.5}.sec{padding:44px 0}.sec-light{background:#f8fafc}.sec-dark{background:var(--bg)}.sec-h{font-size:clamp(18px,5vw,26px);font-weight:800;line-height:1.3;margin-bottom:10px}.sec-sub{font-size:14px;color:var(--gray);margin-bottom:20px;line-height:1.6}.pain-list{display:grid;gap:10px;margin-bottom:18px}.pain-item{display:flex;gap:11px;align-items:flex-start;background:rgba(239,68,68,0.05);border:1px solid rgba(239,68,68,0.13);border-radius:10px;padding:12px 14px}.pain-item::before{content:"✗";color:var(--red);font-weight:700;flex-shrink:0;font-size:14px;margin-top:1px}.pain-item p{font-size:14px;color:#525252}.note-box{text-align:center;padding:14px 16px;background:rgba(34,197,94,0.07);border:1px solid rgba(34,197,94,0.18);border-radius:12px;font-size:14px;color:var(--green-dark);font-weight:600;line-height:1.5}.prog-list{display:grid;gap:12px}.prog-item{display:flex;gap:13px;align-items:flex-start;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:16px}.prog-num{width:36px;height:36px;background:var(--green);border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:16px;flex-shrink:0}.prog-item h3{font-size:14px;font-weight:700;color:#1a1a1a;margin-bottom:4px}.prog-item p{font-size:13px;color:var(--gray);line-height:1.5}.cta-final{background:linear-gradient(135deg,var(--bg),#0f1a0f);padding:44px 0;text-align:center}.cta-final h2{font-size:clamp(18px,5vw,24px);font-weight:800;color:#fff;margin-bottom:10px;line-height:1.35}.cta-final p{font-size:14px;color:var(--light);margin-bottom:22px;line-height:1.6}.ftr{background:var(--bg);border-top:1px solid rgba(255,255,255,0.08);padding:16px 0;text-align:center;color:#475569;font-size:12px}.cta-mid{padding:32px 0;text-align:center}.btn-sub{font-size:13px;color:var(--light);margin-top:10px;text-align:center}</style></head><body>
<section class="hero"><div class="wrap"><div class="hero-in">
<h1>Как перестать тащить строительный бизнес на себе</h1>
<p class="hero-sub">и построить систему, где <span class="hl">80–90% решений принимаются без вас</span></p>
<div class="gold-box"><p class="gold-box-label">Система, которая позволяет:</p><ul><li>▸ убрать большинство ежедневных вопросов («что сегодня делаем», «заказывать материалы»)</li><li>▸ сократить управление до <span class="g">≈60 минут</span> в день</li><li>▸ убрать переделки, срывы сроков и потери на объектах</li></ul></div>
<div class="morning"><p class="morning-label">Как выглядит утро владельца с системой</p><div class="morning-row"><span class="morning-time">08:00</span><span class="morning-text">Открыл телефон. Видишь статус трёх объектов: что сделано, что в работе, где отставание.</span></div><div class="morning-row"><span class="morning-time">08:15</span><span class="morning-text">Один голосовой прорабу по отставанию на втором объекте.</span></div><div class="morning-row"><span class="morning-time">08:30</span><span class="morning-text">Закрыл телефон. Система работает без тебя. Бригада знает что делать. Клиент получает статус.</span></div><div class="morning-row"><span class="morning-time">Вечер</span><span class="morning-text">Возвращаешься — проверяешь результат, не тушишь пожары.</span></div></div>
<p class="hero-note">Даже если у вас уже есть: таблицы или CRM, прораб и субподрядчики, постоянные заказчики — но без вас ни один объект не двигается.</p>
<p class="hero-desc">На мастер-классе вы увидите <strong>готовую систему управления строительным бизнесом в Европе</strong>, которая работает без постоянного личного контроля.</p>
<a href="https://t.me/" class="btn btn-tg">Зарегистрироваться на мастер-класс</a>
<p class="btn-sub">Без теории. Покажем на примере, как это работает.</p>
</div></div></section>

<section class="sec sec-light"><div class="wrap">
<h2 class="sec-h">Если у вас строительный бизнес в Польше, Чехии или Германии</h2>
<div class="pain-list">
<div class="pain-item"><p>Бригада приехала на объект — без вас никто не знает что делать и что заказывать</p></div>
<div class="pain-item"><p>Материалы не заказали вовремя — объект встал, бригада простаивает, дневные ставки идут</p></div>
<div class="pain-item"><p>Сделали не по технологии — переделка за счёт бизнеса плюс штраф от инспекции</p></div>
<div class="pain-item"><p>Несколько объектов — непонятно что зависло, кто что делает и где деньги заказчика</p></div>
<div class="pain-item"><p>Клиент принял работы, а финальный платёж задерживает — никто не контролирует дебиторку</p></div>
</div>
<div class="note-box">В итоге владелец строительного бизнеса в Европе работает не как руководитель,<br>а как прораб, диспетчер и менеджер по претензиям одновременно.</div>
</div></section>

<section class="sec"><div class="wrap">
<h2 class="sec-h">Что вы получите за 60 минут</h2>
<p class="sec-sub">Готовая модель системы управления строительным бизнесом в Европе</p>
<div class="prog-list">
<div class="prog-item"><div class="prog-num">1</div><div><h3>Почему строительный бизнес зависит от владельца</h3><p>Какие процессы создают хаос и почему даже новые прорабы и CRM не решают проблему</p></div></div>
<div class="prog-item"><div class="prog-num">2</div><div><h3>Операционная система строительного бизнеса</h3><p>7 ключевых блоков от приёма заявки до финальной оплаты без вашего участия</p></div></div>
<div class="prog-item"><div class="prog-num">3</div><div><h3>Как выстроить работу бригад по системе</h3><p>Стандарты и контрольные точки которые работают без постоянного надзора владельца</p></div></div>
<div class="prog-item"><div class="prog-num">4</div><div><h3>Как удвоить прибыль за 8 недель</h3><p>Снижение переделок, простоев и дебиторки — без увеличения штата и рекламного бюджета</p></div></div>
<div class="prog-item"><div class="prog-num">5</div><div><h3>Первые шаги внедрения прямо сейчас</h3><p>Переход от ручного управления к операционной системе без остановки объектов</p></div></div>
</div>
</div></section>

<section class="cta-final"><div class="wrap">
<h2>Зарегистрируйтесь на бесплатный мастер-класс</h2>
<p>Четверг · 18:30 по Варшаве · Zoom · Без теории — на реальных примерах бизнесов в Польше, Чехии и Германии</p>
<a href="https://t.me/" class="btn btn-tg">Зарегистрироваться через Telegram</a>
<p class="btn-sub">После регистрации — персональный разбор вашего бизнеса сразу в Telegram.</p>
</div></section>
<footer class="ftr"><div class="wrap"><p>© 2026 TALKO Management System</p></div></footer>
</body></html>`
    },
    {
    ...
    },
    {
        ...
        color: '#f59e0b',
        html: `<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Мастер-класс для мебельного бизнеса</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet"><style>:root{--green:#22c55e;--green-dark:#16a34a;--bg:#0a0f0a;--gray:#64748b;--light:#94a3b8;--red:#ef4444;--blue:#0088cc;--gold:#fbbf24}*{margin:0;padding:0;box-sizing:border-box}html{scroll-behavior:smooth}body{font-family:'Inter',sans-serif;background:#fff;color:#1a1a1a;line-height:1.6;font-size:16px}.wrap{max-width:640px;margin:0 auto;padding:0 20px}.btn{display:block;width:100%;padding:16px 20px;border-radius:12px;font-weight:700;font-size:16px;text-decoration:none;text-align:center;cursor:pointer;border:none}.btn-tg{background:var(--blue);color:#fff}.hero{background:var(--bg);padding:44px 0 52px;position:relative;overflow:hidden}.hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 90% 55% at 50% -10%,rgba(34,197,94,0.13),transparent);pointer-events:none}.hero-in{position:relative}.hero h1{font-size:clamp(22px,6vw,34px);font-weight:800;color:#fff;line-height:1.25;margin-bottom:14px}.hero-sub{font-size:clamp(15px,4vw,20px);font-weight:600;color:#94a3b8;line-height:1.4;margin-bottom:22px}.hero-sub .hl{color:var(--green);font-weight:700}.gold-box{background:rgba(251,191,36,0.07);border:1px solid rgba(251,191,36,0.28);border-radius:14px;padding:18px;margin-bottom:22px}.gold-box-label{font-size:11px;font-weight:700;color:#a8783a;text-transform:uppercase;letter-spacing:.6px;margin-bottom:12px}.gold-box li{list-style:none;font-size:15px;color:#d1d5db;padding:5px 0}.gold-box li .g{color:var(--gold);font-weight:700}.hero-desc{font-size:15px;color:#8da0ad;line-height:1.7;margin-bottom:28px}.hero-desc strong{color:#d1d5db}.morning{background:#0d1a0d;border:1px solid rgba(34,197,94,0.2);border-radius:14px;padding:18px;margin:18px 0}.morning-label{font-size:11px;font-weight:700;color:#4a7a5a;text-transform:uppercase;letter-spacing:.6px;margin-bottom:12px}.morning-row{display:flex;gap:12px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,0.05)}.morning-row:last-child{border-bottom:none}.morning-time{font-size:12px;font-weight:700;color:var(--green);white-space:nowrap;min-width:44px;padding-top:2px}.morning-text{font-size:13px;color:#94a3b8;line-height:1.5}.sec{padding:44px 0}.sec-light{background:#f8fafc}.sec-h{font-size:clamp(18px,5vw,26px);font-weight:800;line-height:1.3;margin-bottom:10px}.sec-sub{font-size:14px;color:var(--gray);margin-bottom:20px;line-height:1.6}.pain-list{display:grid;gap:10px;margin-bottom:18px}.pain-item{display:flex;gap:11px;align-items:flex-start;background:rgba(239,68,68,0.05);border:1px solid rgba(239,68,68,0.13);border-radius:10px;padding:12px 14px}.pain-item::before{content:"✗";color:var(--red);font-weight:700;flex-shrink:0;margin-top:1px}.pain-item p{font-size:14px;color:#525252}.note-box{text-align:center;padding:14px 16px;background:rgba(34,197,94,0.07);border:1px solid rgba(34,197,94,0.18);border-radius:12px;font-size:14px;color:var(--green-dark);font-weight:600;line-height:1.5}.prog-list{display:grid;gap:12px}.prog-item{display:flex;gap:13px;align-items:flex-start;background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:16px}.prog-num{width:36px;height:36px;background:var(--green);border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:16px;flex-shrink:0}.prog-item h3{font-size:14px;font-weight:700;color:#1a1a1a;margin-bottom:4px}.prog-item p{font-size:13px;color:var(--gray);line-height:1.5}.cta-final{background:linear-gradient(135deg,var(--bg),#0f1a0f);padding:44px 0;text-align:center}.cta-final h2{font-size:clamp(18px,5vw,24px);font-weight:800;color:#fff;margin-bottom:10px}.cta-final p{font-size:14px;color:var(--light);margin-bottom:22px;line-height:1.6}.ftr{background:var(--bg);border-top:1px solid rgba(255,255,255,0.08);padding:16px 0;text-align:center;color:#475569;font-size:12px}.btn-sub{font-size:13px;color:var(--light);margin-top:10px;text-align:center}</style></head><body>
<section class="hero"><div class="wrap"><div class="hero-in">
<h1>Как перестать тащить мебельный бизнес на себе</h1>
<p class="hero-sub">и построить систему, где <span class="hl">80–90% решений принимаются без вас</span></p>
<div class="gold-box"><p class="gold-box-label">Система, которая позволяет:</p><ul><li>▸ убрать большинство ежедневных вопросов («когда будет готово», «что делать с этим заказом»)</li><li>▸ сократить управление до <span class="g">≈60 минут</span> в день</li><li>▸ убрать брак, срывы сроков и потери на каждом заказе</li></ul></div>
<div class="morning"><p class="morning-label">Как выглядит утро владельца с системой</p><div class="morning-row"><span class="morning-time">08:00</span><span class="morning-text">Открыл телефон. Видишь статус всех заказов: что в производстве, что готово, где задержка.</span></div><div class="morning-row"><span class="morning-time">08:15</span><span class="morning-text">Один голосовой мастеру по проблемному заказу.</span></div><div class="morning-row"><span class="morning-time">08:30</span><span class="morning-text">Закрыл телефон. Мастер знает что делать. Материал заказан. Клиент получает обновление.</span></div><div class="morning-row"><span class="morning-time">Вечер</span><span class="morning-text">Возвращаешься — проверяешь результат, не разбираешь конфликты с клиентами.</span></div></div>
<p class="hero-desc">На мастер-классе вы увидите <strong>готовую систему управления мебельным бизнесом в Европе</strong>, которая работает без постоянного личного контроля.</p>
<a href="https://t.me/" class="btn btn-tg">Зарегистрироваться на мастер-класс</a>
<p class="btn-sub">Без теории. Покажем на примере, как это работает.</p>
</div></div></section>

<section class="sec sec-light"><div class="wrap">
<h2 class="sec-h">Если у вас мебельный бизнес в Польше, Чехии или Германии</h2>
<div class="pain-list">
<div class="pain-item"><p>Мастер останавливается — без вас не знает что делать дальше и что заказывать</p></div>
<div class="pain-item"><p>Фурнитуру или материал не заказали вовремя — производство встало, клиент ждёт</p></div>
<div class="pain-item"><p>Сделали не по размерам — переделка за счёт бизнеса, клиент требует компенсацию</p></div>
<div class="pain-item"><p>Несколько заказов одновременно — непонятно кто за что отвечает и где деньги клиента</p></div>
<div class="pain-item"><p>Клиент получил мебель, а финальный платёж задерживает — дебиторка накапливается</p></div>
</div>
<div class="note-box">В итоге владелец мебельного бизнеса работает не как руководитель,<br>а как замерщик, диспетчер и менеджер по претензиям одновременно.</div>
</div></section>

<section class="sec"><div class="wrap">
<h2 class="sec-h">Что вы получите за 60 минут</h2>
<p class="sec-sub">Готовая модель системы управления мебельным бизнесом в Европе</p>
<div class="prog-list">
<div class="prog-item"><div class="prog-num">1</div><div><h3>Почему мебельный бизнес зависит от владельца</h3><p>Какие процессы создают хаос и почему таблицы, CRM и новые мастера не решают проблему</p></div></div>
<div class="prog-item"><div class="prog-num">2</div><div><h3>Маршрут заказа от замера до финальной оплаты</h3><p>7 ключевых блоков — каждый этап работает без вашего участия</p></div></div>
<div class="prog-item"><div class="prog-num">3</div><div><h3>Как выстроить работу мастеров по стандартам</h3><p>Регламенты и контрольные точки которые работают без надзора владельца</p></div></div>
<div class="prog-item"><div class="prog-num">4</div><div><h3>Как удвоить прибыль за 8 недель</h3><p>Снижение брака, простоев и дебиторки — без увеличения штата и рекламного бюджета</p></div></div>
<div class="prog-item"><div class="prog-num">5</div><div><h3>Первые шаги внедрения прямо сейчас</h3><p>Переход от ручного управления к операционной системе без остановки производства</p></div></div>
</div>
</div></section>

<section class="cta-final"><div class="wrap">
<h2>Зарегистрируйтесь на бесплатный мастер-класс</h2>
<p>Четверг · 18:30 по Варшаве · Zoom · Без теории — на реальных примерах мебельных бизнесов в Польше, Чехии и Германии</p>
<a href="https://t.me/" class="btn btn-tg">Зарегистрироваться через Telegram</a>
<p class="btn-sub">После регистрации — персональный разбор вашего бизнеса сразу в Telegram.</p>
</div></section>
<footer class="ftr"><div class="wrap"><p>© 2026 TALKO Management System</p></div></footer>
