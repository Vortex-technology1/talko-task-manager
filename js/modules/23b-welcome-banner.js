...
function renderBanner() {
    ...
    const i18n = {
        ua: {
            title: window.t('ласкавоПросимоДоTalko'),
            subtitle: window.t('зробіть3КрокиЩоб'),
            tg_title: window.t('підключиTelegram'),
            tg_desc: 'Отримуй сповіщення про завдання, дедлайни та нагадування прямо в месенджер.',
            tg_btn: 'Підключити',
            tg_done: 'Підключено',
            gcal_title: window.t('підключиGoogleCalendar'),
            gcal_desc: 'Дедлайни завдань автоматично з\'являться у твоєму календарі.',
            gcal_btn: 'Підключити',
            gcal_done: 'Підключено',
            myday_title: window.t('мійДеньТвійРобочий'),
        ...
        ru: {
            title: window.t('доброПожаловатьВTalko'),
            subtitle: window.t('выполните3ШагаЧтобы'),
            tg_title: window.t('подключиTelegram'),
            tg_desc: 'Получай уведомления о задачах, дедлайнах и напоминаниях прямо в мессенджер.',
            tg_btn: 'Подключить',
            tg_done: 'Подключено',
            gcal_title: window.t('подключиGoogleCalendar'),
            gcal_desc: 'Дедлайны задач автоматически появятся в твоём календаре.',
            gcal_btn: 'Подключить',
            gcal_done: 'Подключено',
            myday_title: window.t('мойДеньТвойРабочий'),
