...
function renderBanner() {
    ...
    const i18n = {
        ua: {
            title: '👋 Ласкаво просимо до TALKO!',
            subtitle: 'Зробіть 3 кроки щоб система працювала на повну',
            tg_title: 'Підключи Telegram',
            tg_desc: 'Отримуй сповіщення про завдання, дедлайни та нагадування прямо в месенджер.',
            tg_btn: 'Підключити',
            tg_done: 'Підключено',
            gcal_title: 'Підключи Google Calendar',
            gcal_desc: 'Дедлайни завдань автоматично з\'являться у твоєму календарі.',
            gcal_btn: 'Підключити',
            gcal_done: 'Підключено',
            myday_title: 'Мій день — твій робочий центр',
        ...
        ru: {
            title: '👋 Добро пожаловать в TALKO!',
            subtitle: 'Выполните 3 шага чтобы система работала на полную',
            tg_title: 'Подключи Telegram',
            tg_desc: 'Получай уведомления о задачах, дедлайнах и напоминаниях прямо в мессенджер.',
            tg_btn: 'Подключить',
            tg_done: 'Подключено',
            gcal_title: 'Подключи Google Calendar',
