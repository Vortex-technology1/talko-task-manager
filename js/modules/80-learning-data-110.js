...
<button class="l110-copy-btn" id="l110-copy-btn" onclick="if(typeof window.l110CopyPrompt==='function'){window.l110CopyPrompt();}else{var el=document.getElementById('l110-prompt-content');if(el){navigator.clipboard&&navigator.clipboard.writeText(el.innerText||el.textContent);}}">
