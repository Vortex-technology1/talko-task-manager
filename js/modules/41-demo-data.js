...
'use strict';
        ...
        const _NICHE_LABELS = {
            ...
            autoservice:      'Автосервіс / СТО',
            horeca:           'HoReCa — кафе / ресторан',
            logistics:        'Логістика / Перевезення',
            cleaning:         'Клінінг (Київ)',
        ...
        // mobileFilters + filter functions → moved to 24-table-column-resize-sort.js
        // (were causing ReferenceError on mobile — 41 loaded too late)
